...
namespace Nop.Web.MVC.Tests.Public.Infrastructure
{
    ...
    public class RoutesTests : RoutesTestsBase
    {
        ...
        public void Customer_routes()
        {
            ...
            "~/customer/addresses/".ShouldMapTo<CustomerController>(c => c.Addresses(null));
            "~/order/history/".ShouldMapTo<OrderController>(c => c.CustomerOrders(null));
        ...
        public void Common_routes()
        {
            ...
            "~/sitemap".ShouldMapTo<CommonController>(c => c.Sitemap(new Web.Models.Common.SitemapPageModel()));
