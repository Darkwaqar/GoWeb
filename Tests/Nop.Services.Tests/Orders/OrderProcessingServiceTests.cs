    ...
    public class OrderProcessingServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            _orderTotalCalcService = new OrderTotalCalculationService(_workContext, _storeContext,
                ...
                _taxSettings, _rewardPointsSettings, _shippingSettings, _shoppingCartSettings, _catalogSettings,_vendorService);
            ...
            _productReservationService = MockRepository.GenerateMock<IProductReservationService>();
            _auctionService = MockRepository.GenerateMock<IAuctionService>();
            ...
            _orderProcessingService = new OrderProcessingService(_orderService, _webHelper,
                ...
                _productReservationService, _auctionService);
        }
