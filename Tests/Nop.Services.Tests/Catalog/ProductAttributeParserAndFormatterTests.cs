...
namespace Nop.Services.Tests.Catalog
{
    ...
    public class ProductAttributeParserTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            _productAttributeParser = new ProductAttributeParser(_currencyService,_downloadService,_localizationService
                ,_productAttributeService,_context, _workContext);
