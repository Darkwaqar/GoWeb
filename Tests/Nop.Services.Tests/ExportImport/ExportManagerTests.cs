...
namespace Nop.Services.Tests.ExportImport
{
    ...
    public class ExportManagerTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            _exportManager = new ExportManager(_addressSettings,_catalogSettings,
              _customerSettings, _forumSettings,_addressService,_categoryService,_countryService, _currencyService,_customerAttributeFormatter,_customerService,_dateRangeService,
              _dateTimeHelper,_discountService,_forumService, _gdprService,_genericAttributeService,_localizationService, _manufacturerService,_measureService,_newsLetterSubscriptionService,
              _orderService,_pictureService, _priceFormatter, _productAttributeService,
                _productService,_productTagService,_productTemplateService,_shipmentService, _specificationAttributeService,
                _stateProvinceService,_storeMappingService,_storeService, _taxCategoryService, _urlRecordService, _vendorService, _workContext, _orderSettings, _productEditorSettings);
        }
