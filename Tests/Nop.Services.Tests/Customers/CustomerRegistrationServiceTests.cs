    ...
    public class CustomerRegistrationServiceTests : ServiceTest
    {
        ...
        public new void SetUp()
        {
            ...
            _customerService = new CustomerService(new NopNullCache(), _customerRepo, _customerPasswordRepo, _customerRoleRepo,
                ...
                _genericAttributeService, null, null, _eventPublisher, _customerSettings, null, _storeContext);
        ...
        {
            var result = _customerRegistrationService.ValidateCustomer("registered@test.com", "password", 0);
            result.ShouldEqual(CustomerLoginResults.Successful);

            result = _customerRegistrationService.ValidateCustomer("notregistered@test.com", "password", 0);
        ...
        {
            var result = _customerRegistrationService.ValidateCustomer("a@b.com", "password", 0);
            result.ShouldEqual(CustomerLoginResults.Successful);
        }
        ...
        {
            var result = _customerRegistrationService.ValidateCustomer("test@test.com", "password", 0);
            result.ShouldEqual(CustomerLoginResults.Successful); ;
        }
        ...
        {
            var result = _customerRegistrationService.ValidateCustomer("user@test.com", "password", 0);
            result.ShouldEqual(CustomerLoginResults.Successful);
        }
        ...
        {
            var request = new ChangePasswordRequest("registered@test.com", 1, true, PasswordFormat.Clear, "password", "password");
            var result = _customerRegistrationService.ChangePassword(request);
            result.Success.ShouldEqual(false);

            request = new ChangePasswordRequest("registered@test.com", 1, true, PasswordFormat.Hashed, "newpassword", "password");
