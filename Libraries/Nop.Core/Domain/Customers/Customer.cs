...
namespace Nop.Core.Domain.Customers
{
    ...
    public partial class Customer : BaseEntity
    {
        ...
        private ICollection<CustomerTag> _customerTags;
        ...
        public virtual ICollection<Notification> Notifications
        {
            ...
            protected set { _notifications = value; }
        }

        /// <summary>
        /// Gets or sets the customer tags
        /// </summary>
        public virtual ICollection<CustomerTag> CustomerTags
        {
            get { return _customerTags ?? (_customerTags = new List<CustomerTag>()); }
