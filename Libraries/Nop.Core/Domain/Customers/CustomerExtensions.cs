...
namespace Nop.Core.Domain.Customers
{
    public static class CustomerExtensions
    {
        ...
        public static void RemoveDevice(this Customer customer, Device device)
        {
            if (customer.Devices.Contains(device))
            {
        ...
        public static void RemoveNotification(this Customer customer, Notification notification)
        {
            if (customer.Notifications.Contains(notification))
            {
                customer.Notifications.Remove(notification);
            }
        }
        ...
        public static void RemoveCustomerTag(this Customer customer, CustomerTag customerTag)
        {
            if (customer.CustomerTags.Contains(customerTag))
            {
