...
namespace Nop.Core.Domain.Messages
{
    ...
    /// </summary>
    /// <typeparam name="U"></typeparam>
    public class SMSTokensAddedEvent<U>
    {
        private readonly SMSTemplate _message;
        private readonly IList<U> _tokens;

        public SMSTokensAddedEvent(SMSTemplate message, IList<U> tokens)
        {
            _message = message;
            _tokens = tokens;
        }
    ...
    public class CustomerReminderAdditionTokensAddedEvent : AdditionTokensAddedEvent
    {
    }
}