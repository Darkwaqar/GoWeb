namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// <summary>
        /// Represents system name of notification store owner about cancel order
        /// </summary>
        ...
        /// Represents system name of notification vendor about changing information
        /// </summary>
        public const string VendorReviewNotification = "Vendor.VendorReview";
        ...
        /// Represents system name of 'Contact vendor' message
        /// </summary>
        public const string CustomerNotificationAuctionWin = "AuctionEnded.CustomerNotificationWin";

        /// <summary>
        /// Represents system name of 'Contact vendor' message
        /// </summary>
        public const string CustomerNotificationAuctionLost = "AuctionEnded.CustomerNotificationLost";

        /// <summary>
        /// Represents system name of 'Contact vendor' message
        /// </summary>
        public const string CustomerNotificationAuctionEnded = "AuctionEnded.CustomerNotificationBin";

        /// <summary>
        /// Represents system name of 'Contact vendor' message
        /// </summary>
        public const string StoreOwnerNotificationAuctionEnded = "AuctionEnded.StoreOwnerNotification";

        /// <summary>
        /// Represents system name of 'Contact vendor' message
        /// </summary>
        public const string StoreOwnerNotificationActionEnd = "AuctionEnded.StoreOwnerNotification";

        /// <summary>
        /// Represents system name of 'Contact vendor' message
        /// </summary>
        public const string StoreOwnerNotificationAuctionExpired = "AuctionExpired.StoreOwnerNotification";


        /// <summary>
        /// Represents system name of 'Contact vendor' message
        /// </summary>
        public const string CustomerNotificationBidUp = "BidUp.CustomerNotification";
