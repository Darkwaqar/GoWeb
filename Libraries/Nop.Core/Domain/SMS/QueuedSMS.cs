...
namespace Nop.Core.Domain.SMS
{
    ...
    public partial class QueuedSMS : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the From property (sms address)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the To property (sms address)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the ReplyTo property (sms address)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the date and time in UTC before which this sms should not be sent
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the used number account identifier
        /// </summary>
        ...
        /// </summary>
        public virtual NumberAccount NumberAccount { get; set; }
