...
namespace Nop.Services.Orders
{
    ...
    public partial interface IShoppingCartService
    {
        ...
        IList<ShoppingCartItem> GetShoppingCart(int storeId = 0, params ShoppingCartType[] shoppingCartType);
        ...
        /// <summary>
        /// Migrate oder shopping cart
        /// </summary>
        /// <param name="order">customer order</param>
        /// <param name="toCustomer">To customer</param>
        void MigrateOrderShoppingCart(Order order, Customer toCustomer);
    }
}
