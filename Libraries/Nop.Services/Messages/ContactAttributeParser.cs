...
namespace Nop.Services.Messages
{
    ...
    public partial class ContactAttributeParser : IContactAttributeParser
    {
        ...
        protected virtual IList<int> ParseContactAttributeIds(string attributesXml)
        {
            ...
            foreach (var attribute in attributes)
            {
                ...
                foreach (string valueStr in valuesStr)
                {
                    if (!String.IsNullOrEmpty(valueStr))
                    {
                        ...
                        {
                            var value = _contactAttributeService.GetContactAttributeValueById(id);
                            if (value != null)
                                values.Add(value);
                        }
                    }
        ...
        public virtual IList<string> ParseValues(string attributesXml, int contactAttributeId)
        {
