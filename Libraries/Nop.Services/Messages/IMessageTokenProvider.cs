...
namespace Nop.Services.Messages
{
    public partial interface IMessageTokenProvider
    {
        ...
        void AddCouponTokens(IList<Token> tokens, Coupon coupon);
        ...
        void AddShoppingCartTokens(IList<Token> tokens, Customer customer, Store store, int languageId,
        ...
        void AddContactTokens(IList<Token> tokens, string senderEmail, string senderName, string body, string attrInfo);
        ...
        void AddVendorReviewTokens(IList<Token> tokens, Vendor vendor, Product product, VendorReview vendorReview);
        ...
        /// <param name="tokens">List of already added tokens</param>
        /// <param name="productReview">Product review</param>
        void AddProductAppointmentTokens(IList<Token> tokens, ProductAppointment productAppointment);
        ...
        IEnumerable<string> GetListOfCustomerReminderAllowedTokens(CustomerReminderRuleEnum rule);
