...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCustomerEmailTokenValidationMessage(Customer customer, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendOrderCancelledStoreOwnerNotification(Order order, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendOrderCancelledVendorNotification(Order order, Vendor vendor, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendNewVendorAccountApplyStoreOwnerNotification(Customer customer, Vendor vendor, int languageId, string senderEmail,
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendVendorReviewNotificationMessage(Customer customer, Vendor vendor, Product product, VendorReview vendorReview,
            int languageId);

        /// <summary>
        /// Sends a product review notification message to a store owner
        /// </summary>
        /// <param name="productAppointment">Product review</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendProductAppointmentNotificationMessage(ProductAppointment productAppointment,
            int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCouponNotification(Coupon coupon, int languageId);
        ...
        /// <returns>Queued email identifier</returns>
        int SendContactUsMessage(Customer customer, int languageId, string senderEmail, string senderName, string subject, string body, string attrInfo, string attrXml);
        ...
        /// <param name="body">Email body</param>
        /// <returns>Queued email identifier</returns>
        int SendAppointmentMessage(Customer customer, int languageId, string senderEmail, string senderName, string subject, string body, string attrInfo, string attrXml);
        ...
        /// <param name="body">Email body</param>
        /// <returns>Queued email identifier</returns>
        int SendContactVendorMessage(Customer customer, Vendor vendor, int languageId, string senderEmail,
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendTestSMS(int messageTemplateId, string sendToNumber, List<Token> tokens, int languageId);
        ...
        /// <returns>Queued email identifier</returns>
        int SendCustomerActionEvent_AddToCart_Notification(CustomerAction action, ShoppingCartItem cartItem, int languageId, Customer customer);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCustomerActionEvent_AddToOrder_Notification(CustomerAction action, Order order, Customer customer, int languageId);
        ...
        /// <param name="customerId">Customer identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCustomerActionEvent_Notification(CustomerAction action, int languageId, Customer customer);
        ...
        /// <returns>Queued email identifier</returns>
        int SendAuctionEndedCustomerNotificationWin(Product product, int languageId, Bid bid);
        ...
        /// <param name="Bid">Bid</param>
        /// <returns>Queued email identifier</returns>
        int SendAuctionEndedCustomerNotificationLost(Product product, int languageId, Bid bid);
        ...
        /// <returns>Queued email identifier</returns>
        int SendAuctionEndedCustomerNotificationBin(Product product, int customerId, int languageId, int storeId);
        ...
        /// <param name="Bid">Bid</param>
        /// <returns>Queued email identifier</returns>
        int SendAuctionEndedStoreOwnerNotification(Product product, int languageId, Bid bid);
        ...
        /// <param name="Bid">Bid</param>
        /// <returns>Queued email identifier</returns>
        int SendOutBidCustomerNotification(Product product, int languageId, Bid bid);
