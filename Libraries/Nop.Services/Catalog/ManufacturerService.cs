    ...
    public partial class ManufacturerService : IManufacturerService
    {
        ...
        public virtual void DeleteManufacturers(IList<Manufacturer> manufacturers)
        {
            if (manufacturers == null)
                throw new ArgumentNullException("manufacturers");
        ...
        /// <summary>
        /// Gets manufacturer by identifier
        /// </summary>
        ...
        public virtual IList<Manufacturer> GetManufacturersByIds(int[] manufacturerIds)
        {
            ...
            var sortedManufacturers = new List<Manufacturer>();
            foreach (int id in manufacturerIds)
            {
                var manufacturer = manufacturers.Find(x => x.Id == id);
                if (manufacturer != null)
                    sortedManufacturers.Add(manufacturer);
            }
        ...
        public virtual void UpdateManufacturers(IList<Manufacturer> manufacturers)
        {
            if (manufacturers == null)
                throw new ArgumentNullException("manufacturers");
