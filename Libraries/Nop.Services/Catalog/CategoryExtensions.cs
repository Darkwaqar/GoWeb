...
namespace Nop.Services.Catalog
{
    ...
    public static class CategoryExtensions
    {
        ...
        /// <summary>
        /// Returns a VendorMappedCategory that has the specified values
        /// </summary>
        /// <param name="source">Source</param>
        /// <param name="vendorId">Vendor identifier</param>
        /// <param name="categoryId">Category identifier</param>
        /// <returns>A ProductCategory that has the specified values; otherwise null</returns>
        public static VendorMappedCategory FindVendorMappedCategory(this IList<VendorMappedCategory> source,
            int vendorId, int categoryId)
        {
            foreach (var vendorMappedCategory in source)
                if (vendorMappedCategory.VendorId == vendorId && vendorMappedCategory.CategoryId == categoryId)
                    return vendorMappedCategory;
