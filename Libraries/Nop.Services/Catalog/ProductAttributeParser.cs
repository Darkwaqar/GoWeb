...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeParser : IProductAttributeParser
    {
        ...
        /// <param name="attributesXml">Attributes in XML format</param>
        protected virtual void AddGiftCardsAttributesXml(Product product, FormCollection form, ref string attributesXml)
        {
        ...
        protected virtual string GetProductAttributesXml(Product product, FormCollection form, List<string> errors)
        {
        ...
        public virtual decimal ParseCustomerEnteredPrice(Product product, FormCollection form)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            if (form == null)
        ...
        /// <param name="form">Form</param>
        /// <returns>Customer entered price of the product</returns>
        public virtual int ParseEnteredQuantity(Product product, FormCollection form)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            if (form == null)
            ...
            foreach (var formKey in form.AllKeys)
            {
                if (formKey.Equals(string.Format("addtocart_{0}.EnteredQuantity", product.Id), StringComparison.InvariantCultureIgnoreCase))
                {
        ...
        public virtual void ParseRentalDates(Product product, FormCollection form, out DateTime? startDate, out DateTime? endDate)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            if (form == null)
        ...
        /// <param name="errors">Errors</param>
        /// <returns>Attributes in XML format</returns>
        public virtual string ParseProductAttributes(Product product, FormCollection form, List<string> errors)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            if (form == null)
