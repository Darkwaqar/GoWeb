...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        /// </summary>
        /// <returns>Products</returns>
        IList<Product> GetAllVendorHomePageProduct(int vendorId);
        ...
        void UpdateMostView(int productId);
        ...
        void UpdateSold(int productId, int qty);
        ...
        /// </param>
        /// <returns>Products</returns>
        IPagedList<Product> SearchProductsAdvance(
            out IList<int> filterableSpecificationAttributeOptionIds,
            bool loadFilterableSpecificationAttributeOptionIds = false,
            int pageIndex = 0,
            int pageSize = int.MaxValue,
        ...
        /// <param name="pageSize">Page size</param>
        /// <returns>Products</returns>
        IPagedList<Product> GetProductsByProductSpecificationId(int specificationAttributeOptionId,
            int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        void UpdateIntervalProperties(int productId, int interval, IntervalUnit intervalUnit, bool includeBothDates);
