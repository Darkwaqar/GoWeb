...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductAttributeParser
    {
        ...
        decimal ParseCustomerEnteredPrice(Product product, FormCollection form);
        ...
        /// <param name="form">Form</param>
        /// <returns>Customer entered price of the product</returns>
        int ParseEnteredQuantity(Product product, FormCollection form);
        ...
        void ParseRentalDates(Product product, FormCollection form, out DateTime? startDate, out DateTime? endDate);
        ...
        string ParseProductAttributes(Product product, FormCollection form, List<string> errors);
