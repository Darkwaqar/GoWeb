...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
            ...
            PictureType defaultPictureType = PictureType.Entity)
        {
            ...
            string lastPart = _mediaSettings.NextGenImages? GetFileExtensionFromMimeType(MimeTypes.ImageWebp) : GetFileExtensionFromMimeType(picture.MimeType);
            ...
            using (var mutex = new Mutex(false, thumbFileName))
            {
                if (!GeneratedThumbExists(thumbFilePath, thumbFileName))
                {
                    ...
                    if (!GeneratedThumbExists(thumbFilePath, thumbFileName))
                    {
                        ...
                        {
                            SaveThumb(thumbFilePath, thumbFileName, picture.MimeType, pictureBinary);
                            mutex.ReleaseMutex();
                        }
                    }
