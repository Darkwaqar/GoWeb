    ...
    public partial class GdprService : IGdprService
    {
        ...
        public virtual void PermanentDeleteCustomer(Customer customer)
        {
            ...
            foreach (var ear in customer.ExternalAuthenticationRecords)
                customer.ExternalAuthenticationRecords.Remove(ear);
            ...
            //generic attributes
            var genericAttributes = _genericAttributeService.GetAttributesForEntity(customer.Id, "Customer");
            ...
            if (customer.IsRegistered())
            {
                ...
                customer.CustomerRoles.Remove(
                    customer.CustomerRoles.FirstOrDefault(mapping => mapping.Id == registeredRole.Id));
            }
