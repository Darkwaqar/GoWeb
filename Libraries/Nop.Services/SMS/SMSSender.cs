...
namespace Nop.Services.SMS
{
    ...
    public partial class SMSSender : ISMSSender
    {
        ...
        public SMSSender(IDownloadService downloadService)
        {
        ...
        /// Sends an email
        /// </summary>
        /// <param name="emailAccount">SMS account to use</param>
        ...
        public virtual void SendSMS(NumberAccount emailAccount, string subject, string body,
            ...
            int attachedDownloadId = 0, IDictionary<string, string> headers = null)
        {
            ...
            TwilioClient.Init(emailAccount.AccountSid, emailAccount.AuthToken);

            var sendMessage = MessageResource.Create(
                body: body,
                from: new Twilio.Types.PhoneNumber(emailAccount.Number),
