...
namespace Nop.Services.Logging
{
    ...
    public class CustomerActivityService : ICustomerActivityService
    {
        ...
        {
            return InsertActivity(_workContext.CurrentCustomer, systemKeyword, 0, comment, commentParams);
        }
        ...
        /// </summary>
        /// <param name="systemKeyword">The system keyword</param>
        /// <param name="entityKeyId">The EntityKey</param>
        /// <param name="comment">The activity comment</param>
        /// <param name="commentParams">The activity comment parameters for string.Format() function.</param>
        /// <returns>Activity log item</returns>
        public virtual ActivityLog InsertActivity(string systemKeyword, int entityKeyId, string comment, params object[] commentParams)
        {
            return InsertActivity(_workContext.CurrentCustomer, systemKeyword, entityKeyId, comment, commentParams);
        }
        ...
        /// <param name="commentParams">The activity comment parameters for string.Format() function.</param>
        /// <returns>Activity log item</returns>
        public virtual ActivityLog InsertActivity(Customer customer, string systemKeyword, int entityKeyId, string comment, params object[] commentParams)
        {
            if (customer == null)
                return null;
