...
{
    /// <summary>
    /// Appointment attribute helper
    /// </summary>
    public partial class AppointmentAttributeFormatter : IAppointmentAttributeFormatter
    {
        private readonly IWorkContext _workContext;
        private readonly IAppointmentAttributeService _checkoutAttributeService;
        private readonly IAppointmentAttributeParser _checkoutAttributeParser;
        private readonly IDownloadService _downloadService;
        private readonly IWebHelper _webHelper;

        public AppointmentAttributeFormatter(IWorkContext workContext,
            IAppointmentAttributeService checkoutAttributeService,
            IAppointmentAttributeParser checkoutAttributeParser,
            ...
            bool allowHyperlinks = true)
        {
            ...
            var attributes = _checkoutAttributeParser.ParseAppointmentAttributes(attributesXml);
            for (int i = 0; i < attributes.Count; i++)
            {
                ...
                for (int j = 0; j < valuesStr.Count; j++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            var attributeValue = _checkoutAttributeService.GetAppointmentAttributeValueById(attributeValueId);
