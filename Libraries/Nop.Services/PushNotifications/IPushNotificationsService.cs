...
namespace Nop.Services.PushNotifications
{
    public interface IPushNotificationsService
    {
        ...
        PushRegistration GetPushReceiverByCustomerId(int CustomerId);
        ...
        /// </summary>
        /// <param name="Id"></param>
        PushRegistration GetPushReceiver(int Id);
        ...
        (bool, string) SendPushNotification(string title, string text, string pictureUrl, string clickUrl, List<string> registrationIds = null);
        ...
        /// <param name="clickUrl"></param>
        /// <returns>Bool indicating whether message was sent successfully and string result to display</returns>
        (bool, string) SendPushNotification(string title, string text, string pictureUrl, int customerId, string clickUrl);
    }
}
