...
namespace Nop.Services.PushNotifications
{
    public class PushNotificationsService : IPushNotificationsService
    {
        ...
        public PushNotificationsService(IRepository<PushRegistration> pushRegistratiosnRepository,
        ...
        public virtual PushRegistration GetPushReceiverByCustomerId(int CustomerId)
        {
        ...
        public virtual (bool, string) SendPushNotification(string title, string text, string pictureUrl, string clickUrl, List<string> registrationIds = null)
        {
        ...
        /// <param name="clickUrl"></param>
        /// <returns>Bool indicating whether message was sent successfully and string result to display</returns>
        public virtual (bool, string) SendPushNotification(string title, string text, string pictureUrl, int customerId, string clickUrl)
        {
        ...
        /// </summary>
        /// <param name="Id"></param>
        public virtual PushRegistration GetPushReceiver(int Id)
        {
