...
{
    /// <summary>
    /// Vendor attribute parser
    /// </summary>
    public partial class VendorAttributeParser : IVendorAttributeParser
    {
        private readonly IVendorAttributeService _vendorAttributeService;

        public VendorAttributeParser(IVendorAttributeService vendorAttributeService)
        {
            this._vendorAttributeService = vendorAttributeService;
        }

        /// <summary>
        /// Gets selected vendor attribute identifiers
        /// </summary>
        /// <param name="attributesXml">Attributes in XML format</param>
        /// <returns>Selected vendor attribute identifiers</returns>
        ...
        public virtual string AddVendorAttribute(string attributesXml, VendorAttribute ca, string value)
        {
        ...
        public virtual bool? IsConditionMet(VendorAttribute attribute, string selectedAttributesXml)
        {
            if (attribute == null)
            ...
            var dependOnAttribute = ParseVendorAttributes(conditionAttributeXml).FirstOrDefault();
        ...
        public virtual string RemoveVendorAttribute(string attributesXml, VendorAttribute attribute)
        {
            string result = string.Empty;
            try
            {
