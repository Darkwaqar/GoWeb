...
namespace Nop.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallCountriesAndStates()
        {
            ...
            cPakistan.StateProvinces.Add(new StateProvince
            {
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            ...
            customerRegistrationService.ChangePassword(new ChangePasswordRequest(defaultUserEmail, 1, false,
        ...
        protected virtual void InstallMessageTemplates()
        {
            ...
            var messageTemplates = new List<MessageTemplate>
            {
                 new MessageTemplate
                {
                    Name = MessageTemplateSystemNames.CustomerEmailTokenValidationMessage,
                ...
                new MessageTemplate
                {
                    Name = MessageTemplateSystemNames.OrderCancelledVendorNotification,
                ...
                new MessageTemplate
                    {
                        Name = MessageTemplateSystemNames.CustomerNotificationAuctionWin,
                ...
                new MessageTemplate
                        {
                            Name =MessageTemplateSystemNames.CustomerNotificationAuctionLost,
                            Subject = "%Store.Name%. Auction ended.",
                ...
                new MessageTemplate
                        {
                            Name = MessageTemplateSystemNames.CustomerNotificationAuctionEnded,
                            Subject = "%Store.Name%. Auction ended.",
                ...
                new MessageTemplate
                    {
                        Name = MessageTemplateSystemNames.StoreOwnerNotificationActionEnd,
                        Subject = "%Store.Name%. Auction ended.",
                ...
                new MessageTemplate
                    {
                        Name = MessageTemplateSystemNames.StoreOwnerNotificationAuctionExpired,
                ...
                new MessageTemplate
                    {
                        Name = MessageTemplateSystemNames.CustomerNotificationBidUp,
                ...
                new MessageTemplate
                {
                    Name = MessageTemplateSystemNames.VendorReviewNotification,
        ...
        protected virtual void InstallSettings(bool installSampleData)
        {
            ...
            settingService.SaveSetting(new AdminAreaSettings
            {
                ...
                UseRichEditorInSMSTemplates = false,
            ...
            settingService.SaveSetting(new CatalogSettings
            {
                ...
                DisplayQuantityOnCatalogPages = false,
                SecondPictureOnCatalogPages = false,
                ShowManufacturerPartNumber = false,
                ShowGtin = false,
                ShowFreeShippingNotification = true,
                AllowProductSorting = true,
                DefaultProductSorting= 0,
                AllowProductFilter = true,
                ...
                ProductAppointmentsMustBeApproved = false,
                DefaultProductRatingValue = 5,
                AllowAnonymousUsersToReviewProduct = false,
                AllowAnonymousUsersToAppointmentProduct = false,
                ProductReviewPossibleOnlyAfterPurchasing = false,
                NotifyStoreOwnerAboutNewProductReviews = false,
                NotifyStoreOwnerAboutNewVendorReviews = false,
                NotifyStoreOwnerAboutNewProductAppointments = false,
                ...
                ShowProductAppointmentsTabOnAccountPage = true,
                ProductReviewsPageSizeOnAccountPage = 10,
                ProductAppointmentsPageSizeOnAccountPage = 10,
            ...
            settingService.SaveSetting(new CustomerSettings
            {
                ...
                HideProductAppointmentsTab = false,
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                InstagramLink = "https://instagram.com/+nopcommerce",
                LinkedInLink = "https://LinkedIn.com/+nopcommerce",
                PinterestLink = "https://Pinterest.com/+nopcommerce",
            ...
            settingService.SaveSetting(new ShippingSettings
            {
                ...
                StoreFreeShippingOverXEnabled = true,
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                ...
                new ScheduleTask
                {
                    Name = "Customer reminder - Birthday",
                    Type = "Nop.Services.Customers.CustomerReminderBirthdayTask, Nop.Services",
                    Enabled = false,
                    StopOnError = false,
                    Seconds = 1440
                },
                new ScheduleTask
                {
                    Name = "Customer reminder - Completed order",
                    Type = "Nop.Services.Customers.CustomerReminderCompletedOrderTask, Nop.Services",
                    Enabled = false,
                    StopOnError = false,
                    Seconds = 1440
                },
                new ScheduleTask
                {
                    Name = "Customer reminder - Unpaid order",
                    Type = "Nop.Services.Customers.CustomerReminderUnpaidOrderTask, Nop.Services",
                    Enabled = false,
                    StopOnError = false,
                    Seconds = 1440
                },
                new ScheduleTask
                {
                    Name = "End of the auctions",
                    Type = "Nop.Services.Catalog.EndAuctionsTask, Nop.Services",
                    Enabled = false,
                    StopOnError = false,
                    Seconds = 60
                },
