...
namespace Nop.Web.Framework
{
    public static class HtmlExtensions
    {
        ...
        #region Enable / Disable  CategoryConfirmation

        public static MvcHtmlString CategoryEnableConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseNopEntityModel
        {
            return CategoryEnableConfirmation(helper, "", buttonsSelector);
        }

        public static MvcHtmlString CategoryEnableConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseNopEntityModel
        {
            if (String.IsNullOrEmpty(actionName))
                actionName = "EnableCategory";

            var modalId = MvcHtmlString.Create(helper.ViewData.ModelMetadata.ModelType.Name.ToLower() + "-enable-confirmation")
                .ToHtmlString();
            ...
            window.AppendLine(helper.Partial("Enable", deleteConfirmationModel).ToHtmlString());
        ...
        public static MvcHtmlString CategoryDisableConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseNopEntityModel
        {
            return CategoryDisableConfirmation(helper, "", buttonsSelector);
        }

        public static MvcHtmlString CategoryDisableConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseNopEntityModel
        {
            if (String.IsNullOrEmpty(actionName))
                actionName = "DisableCategory";

            var modalId = MvcHtmlString.Create(helper.ViewData.ModelMetadata.ModelType.Name.ToLower() + "-disable-confirmation")
                .ToHtmlString();
            ...
            var window = new StringBuilder();
            window.AppendLine(string.Format("<div id='{0}' class=\"modal fade\"  tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"{0}-title\">", modalId));
            window.AppendLine(helper.Partial("Disable", deleteConfirmationModel).ToHtmlString());
            window.AppendLine("</div>");
        ...
        #region Enable / Disable  ProductConfirmation

        public static MvcHtmlString ProductEnableConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseNopEntityModel
        {
            return ProductEnableConfirmation(helper, "", buttonsSelector);
        }

        public static MvcHtmlString ProductEnableConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseNopEntityModel
        {
            if (String.IsNullOrEmpty(actionName))
                actionName = "EnableProducts";

            var modalId = MvcHtmlString.Create("product-enable-confirmation")
                .ToHtmlString();
        ...
        public static MvcHtmlString ProductDisableConfirmation<T>(this HtmlHelper<T> helper, string buttonsSelector) where T : BaseNopEntityModel
        {
            return ProductDisableConfirmation(helper, "", buttonsSelector);
        }

        public static MvcHtmlString ProductDisableConfirmation<T>(this HtmlHelper<T> helper, string actionName,
            string buttonsSelector) where T : BaseNopEntityModel
        {
            if (String.IsNullOrEmpty(actionName))
                actionName = "DisableProducts";

            var modalId = MvcHtmlString.Create("product-disable-confirmation")
                .ToHtmlString();
