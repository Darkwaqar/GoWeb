...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<InteractiveFormAttributeService>().As<IInteractiveFormAttributeService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<QueuedFcmService>().As<IQueuedFcmService>().InstancePerLifetimeScope();
            builder.RegisterType<QueuedSMSService>().As<IQueuedSMSService>().InstancePerLifetimeScope();
            builder.RegisterType<FcmApplicationService>().As<IFcmApplicationService>().InstancePerLifetimeScope();
            builder.RegisterType<FcmActionService>().As<IFcmActionService>().InstancePerLifetimeScope();
            builder.RegisterType<MagazineService>().As<IMagazineService>().InstancePerLifetimeScope();
            builder.RegisterType<NewsLetterSubscriptionService>().As<INewsLetterSubscriptionService>().InstancePerLifetimeScope();
            builder.RegisterType<CampaignService>().As<ICampaignService>().InstancePerLifetimeScope();
            builder.RegisterType<EmailAccountService>().As<IEmailAccountService>().InstancePerLifetimeScope();
            builder.RegisterType<NumberAccountService>().As<INumberAccountService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<FcmSender>().As<IFcmSender>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<AppointmentAttributeFormatter>().As<IAppointmentAttributeFormatter>().InstancePerLifetimeScope();
            builder.RegisterType<AppointmentAttributeParser>().As<IAppointmentAttributeParser>().InstancePerLifetimeScope();
            builder.RegisterType<AppointmentAttributeService>().As<IAppointmentAttributeService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ShopTheLookService>().As<IShopTheLookService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<PollCategoryService>().As<IPollCategoryService>().InstancePerLifetimeScope();
