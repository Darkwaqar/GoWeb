...
namespace Nop.Web.Controllers
{
    public partial class OrderController : BasePublicController
    {
        ...
        public virtual ActionResult CustomerOrders(int? page)
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return new HttpUnauthorizedResult();

            var model = _orderModelFactory.PrepareCustomerOrderListModel(page);
            return View(model);
        }
        ...
        public virtual ActionResult CancelOrder(int orderId)
        {
            var order = _orderService.GetOrderById(orderId);
        ...
        public virtual ActionResult AddOrderNote(int orderId)
        {
        ...
        //My account / Order details page / Add order note
        [HttpPost, ActionName("AddOrderNote")]
        [PublicAntiForgery]
        public virtual ActionResult AddOrderNote(AddOrderNoteModel model)
        {
            if (!_orderSettings.AllowCustomerToAddOrderNote)
                return RedirectToRoute("HomePage");
