...
namespace Nop.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseNopModel
    {
        public ShoppingCartModel()
        {
            ...
            VendorItems = new List<VendorShoppingCartItemModel>();
        ...
        public IList<VendorShoppingCartItemModel> VendorItems { get; set; }
        ...
        public partial class ShoppingCartItemModel : BaseNopEntityModel
        {
            ...
            public IList<string> Warnings { get; set; }
            public string AttributeInfoXml { get; set; }
        ...
        public partial class VendorShoppingCartItemModel
        {
            public VendorShoppingCartItemModel()
            {
                Items = new List<ShoppingCartItemModel>();
            }
            public int VendorId { get; set; }
            ...
            public string ShippingChargesFormatted { get; set; }
