...
namespace Nop.Admin.Models.Settings
{
    public partial class VendorSettingsModel : BaseNopModel
    {
        ...
        #region Extended
        [NopResourceDisplayName("Admin.Configuration.Settings.Vendor.DefaultShippingCharge")]
        public decimal DefaultShippingCharge { get; set; }
        public bool DefaultShippingCharge_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Vendor.DefaultCommissionPercentage")]
