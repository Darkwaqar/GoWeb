...
namespace Nop.Admin.Models.Customers
{
    ...
    public partial class CustomerModel : BaseNopEntityModel
    {
        public CustomerModel()
        {
            ...
            this.AvailableNewsletterSubscriptionVendors = new List<VendorModel>();
        }
        ...
        //newsletter subscriptions (per Vendor)
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.Newsletter")]
        public List<VendorModel> AvailableNewsletterSubscriptionVendors { get; set; }
        [NopResourceDisplayName("Admin.Customers.Customers.Fields.Newsletter")]
        public int[] SelectedNewsletterSubscriptionVendorIds { get; set; }
