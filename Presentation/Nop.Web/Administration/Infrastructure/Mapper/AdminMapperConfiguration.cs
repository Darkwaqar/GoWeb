    ...
    public class AdminMapperConfiguration : IMapperConfiguration
    {
        ...
        public Action<IMapperConfigurationExpression> GetConfiguration()
        {
            ...
            Action<IMapperConfigurationExpression> action = cfg =>
            {
                ...
                //appointment
                cfg.CreateMap<ProductAppointment, ProductAppointmentModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<ProductAppointmentModel, ProductAppointment>();

                //device
                cfg.CreateMap<Device, DeviceModel>()
                    .ForMember(dest => dest.DeviceHtml, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                ...
                cfg.CreateMap<Notification, NotificationModel>()
                    .ForMember(dest => dest.AvailableActions, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableApplications, mo => mo.Ignore())
                ...
                //fcmApplication
                cfg.CreateMap<FcmApplication, FcmApplicationModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<FcmApplicationModel, FcmApplication>();

                //fcmAction
                cfg.CreateMap<FcmAction, FcmActionModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<FcmActionModel, FcmAction>();

                //shopTheLook
                cfg.CreateMap<Pointer, PointerModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<PointerModel, Pointer>();
                ...
                cfg.CreateMap<EmailAccountModel, EmailAccount>()
                    .ForMember(dest => dest.Password, mo => mo.Ignore());
                //number account
                cfg.CreateMap<NumberAccount, NumberAccountModel>()
                    .ForMember(dest => dest.IsDefaultNumberAccount, mo => mo.Ignore())
                    .ForMember(dest => dest.SendTestSMSTo, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<NumberAccountModel, NumberAccount>();
                ...
                cfg.CreateMap<MessageTemplateModel, MessageTemplate>()
                    ...
                    .ForMember(dest => dest.LimitedToStores, mo => mo.Ignore());
                //sms template
                cfg.CreateMap<SMSTemplate, SMSTemplateModel>()
                    .ForMember(dest => dest.AllowedTokens, mo => mo.Ignore())
                    .ForMember(dest => dest.HasAttachedDownload, mo => mo.Ignore())
                    .ForMember(dest => dest.Locales, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableNumberAccounts, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableStores, mo => mo.Ignore())
                    .ForMember(dest => dest.ListOfStores, mo => mo.Ignore())
                    .ForMember(dest => dest.SelectedStoreIds, mo => mo.Ignore())
                    .ForMember(dest => dest.SendImmediately, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<SMSTemplateModel, SMSTemplate>()
                    .ForMember(dest => dest.DelayPeriod, mo => mo.Ignore())
                    .ForMember(dest => dest.LimitedToStores, mo => mo.Ignore());
                //queued email
                ...
                //queued sms
                cfg.CreateMap<QueuedSMS, QueuedSMSModel>()
                    .ForMember(dest => dest.NumberAccountName,
                        mo => mo.MapFrom(src => src.NumberAccount != null ? src.NumberAccount.FriendlyName : string.Empty))
                    .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                    .ForMember(dest => dest.PriorityName, mo => mo.Ignore())
                    .ForMember(dest => dest.DontSendBeforeDate, mo => mo.Ignore())
                    .ForMember(dest => dest.SendImmediately, mo => mo.Ignore())
                    .ForMember(dest => dest.SentOn, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<QueuedSMSModel, QueuedSMS>()
                    .ForMember(dest => dest.Priority, dt => dt.Ignore())
                    .ForMember(dest => dest.PriorityId, dt => dt.Ignore())
                    .ForMember(dest => dest.CreatedOnUtc, dt => dt.Ignore())
                    .ForMember(dest => dest.DontSendBeforeDateUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.SentOnUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.NumberAccount, mo => mo.Ignore())
                    .ForMember(dest => dest.NumberAccountId, mo => mo.Ignore())
                    .ForMember(dest => dest.AttachmentFilePath, mo => mo.Ignore())
                    .ForMember(dest => dest.AttachmentFileName, mo => mo.Ignore());

                //queued fcm
                cfg.CreateMap<QueuedFcm, QueuedFcmModel>()
                    .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                    .ForMember(dest => dest.PriorityName, mo => mo.Ignore())
                    .ForMember(dest => dest.DontSendBeforeDate, mo => mo.Ignore())
                    .ForMember(dest => dest.SendImmediately, mo => mo.Ignore())
                    .ForMember(dest => dest.SentOn, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<QueuedFcmModel, QueuedFcm>()
                    .ForMember(dest => dest.Priority, dt => dt.Ignore())
                    .ForMember(dest => dest.PriorityId, dt => dt.Ignore())
                    .ForMember(dest => dest.CreatedOnUtc, dt => dt.Ignore())
                    .ForMember(dest => dest.DontSendBeforeDateUtc, mo => mo.Ignore())
                ...
                cfg.CreateMap<Banner, BannerModel>()
                    ...
                    .ForMember(dest => dest.BannerPictureModels, mo => mo.Ignore())
                    .ForMember(dest => dest.Locales, mo => mo.Ignore());
                ...
                cfg.CreateMap<InteractiveFormModel, InteractiveForm>()
                    ...
                    .ForMember(dest => dest.InteractiveFormAttributes, mo => mo.Ignore());

                cfg.CreateMap<InteractiveFormAttribute, InteractiveFormAttributeModel>()
                    .ForMember(dest => dest.Locales, mo => mo.Ignore());

                cfg.CreateMap<InteractiveFormAttributeModel, InteractiveFormAttribute>()
                    .ForMember(dest => dest.Id, mo => mo.Ignore());

                cfg.CreateMap<InteractiveFormAttributeValue, InteractiveFormAttributeValueModel>()
                    .ForMember(dest => dest.Locales, mo => mo.Ignore());

                cfg.CreateMap<InteractiveFormAttributeValueModel, InteractiveFormAttributeValue>()
                    .ForMember(dest => dest.Id, mo => mo.Ignore());
                ...
                cfg.CreateMap<PushNotificationsSettings, PushNotificationsSettingsModel>()
                     .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<PushNotificationsSettingsModel, PushNotificationsSettings>();
                //topcis
                ...
                cfg.CreateMap<Vendor, VendorModel>()
                    ...
                    .ForMember(dest => dest.Locales, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableCategories, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailablePlatform, mo => mo.Ignore())
                    .ForMember(dest => dest.AvaliableThemeColor, mo => mo.Ignore())
                    .ForMember(dest => dest.SeName, mo => mo.MapFrom(src => src.GetSeName(0, true, false)))
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<VendorModel, Vendor>()
                    .ForMember(dest => dest.VendorNotes, mo => mo.Ignore())
                    .ForMember(dest => dest.VendorMappedCategories, mo => mo.Ignore())
                    .ForMember(dest => dest.Deleted, mo => mo.Ignore());

                //vendor attribute
                cfg.CreateMap<VendorAttribute, VendorAttributeModel>()
                   .ForMember(dest => dest.AttributeControlTypeName, mo => mo.Ignore())
                   .ForMember(dest => dest.Locales, mo => mo.Ignore())
                   .ForMember(dest => dest.AvailableStores, mo => mo.Ignore())
                   .ForMember(dest => dest.SelectedStoreIds, mo => mo.Ignore())
                   .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<VendorAttributeModel, VendorAttribute>()
                ...
                //mobileAppSettings
                cfg.CreateMap<MobileAppSetting, MobileAppSettingModel>()
                .ForMember(dest => dest.AvailableImageAspectRatio, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableTabAnimation, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableShopTheLookType, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableHomeTabType, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<MobileAppSettingModel, MobileAppSetting>();
                ...
                //vendorPaymentinfo
                cfg.CreateMap<VendorPaymentInfo, VendorPaymentInfoModel>()
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<VendorPaymentInfoModel, VendorPaymentInfo>();

                //vendorPayouts
                cfg.CreateMap<VendorPayout, VendorPayoutModel>()
                 .ForMember(dest => dest.PayoutStatusName, mo => mo.Ignore())
                 .ForMember(dest => dest.PayoutAmount, mo => mo.Ignore())
                 .ForMember(dest => dest.CurrencySymbol, mo => mo.Ignore())
                 .ForMember(dest => dest.VendorOrderTotal, mo => mo.Ignore())
                 .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<VendorPayoutModel, VendorPayout>();

                //vendorReview
                cfg.CreateMap<VendorReview, VendorReviewModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore()); ;
                cfg.CreateMap<VendorReviewModel, VendorReview>();

                //magazine
                cfg.CreateMap<Magazine, MagazineModel>()
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore())
                    .ForMember(dest => dest.PictureThumbnailUrl, mo => mo.Ignore())
                    .ForMember(dest => dest.CreatedOn, mo => mo.Ignore())
                    .ForMember(dest => dest.UpdatedOn, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<MagazineModel, Magazine>()
                    .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.UpdatedOnUtc, mo => mo.Ignore());
                ...
                //category
                cfg.CreateMap<PollCategory, PollCategoryModel>()
                    .ForMember(dest => dest.PictureThumbnailUrl, mo => mo.Ignore())
                    .ForMember(dest => dest.Locales, mo => mo.Ignore())
                    .ForMember(dest => dest.SeName, mo => mo.MapFrom(src => src.GetSeName(0, true, false)))
                    .ForMember(dest => dest.AvailableCustomerRoles, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.SelectedStoreIds, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<PollCategoryModel, PollCategory>()
                    .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.UpdatedOnUtc, mo => mo.Ignore())
                    .ForMember(dest => dest.Deleted, mo => mo.Ignore())
                    .ForMember(dest => dest.SubjectToAcl, mo => mo.Ignore())
                ...
                //contact attributes
                cfg.CreateMap<ContactAttribute, ContactAttributeModel>()
                    .ForMember(dest => dest.AttributeControlTypeName, mo => mo.Ignore())
                    .ForMember(dest => dest.Locales, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableStores, mo => mo.Ignore())
                    .ForMember(dest => dest.SelectedStoreIds, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.ConditionModel, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<ContactAttributeModel, ContactAttribute>()
                    .ForMember(dest => dest.AttributeControlType, mo => mo.Ignore())
                    .ForMember(dest => dest.ConditionAttributeXml, mo => mo.Ignore())
                ...
                cfg.CreateMap<AppointmentAttribute, AppointmentAttributeModel>()
                    .ForMember(dest => dest.AttributeControlTypeName, mo => mo.Ignore())
                    .ForMember(dest => dest.Locales, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableStores, mo => mo.Ignore())
                    .ForMember(dest => dest.SelectedStoreIds, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.ConditionModel, mo => mo.Ignore())
                    .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
                cfg.CreateMap<AppointmentAttributeModel, AppointmentAttribute>()
                    .ForMember(dest => dest.AttributeControlType, mo => mo.Ignore())
                    .ForMember(dest => dest.ConditionAttributeXml, mo => mo.Ignore())
                    .ForMember(dest => dest.AppointmentAttributeValues, mo => mo.Ignore())
                    .ForMember(dest => dest.LimitedToStores, mo => mo.Ignore())
                    .ForMember(dest => dest.SubjectToAcl, mo => mo.Ignore());
                ...
                cfg.CreateMap<CouponModel, Coupon>()
                    .ForMember(dest => dest.CouponType, mo => mo.Ignore())
                    .ForMember(dest => dest.CouponUsageHistory, mo => mo.Ignore())
                    .ForMember(dest => dest.IsRecipientNotified, mo => mo.Ignore())
                    .ForMember(dest => dest.CreatedOnUtc, mo => mo.Ignore());
                //stores
                ...
                cfg.CreateMap<VendorSettings, VendorSettingsModel>()
                    ...
                    .ForMember(dest => dest.DefaultCommissionPercentage_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.DefaultShippingCharge_OverrideForStore, mo => mo.Ignore());
                ...
                cfg.CreateMap<ShippingSettings, ShippingSettingsModel>()
                    ...
                    .ForMember(dest => dest.NotifyCustomerAboutShippingFromMultipleLocations_OverrideForStore,
                        mo => mo.Ignore())
                    .ForMember(dest => dest.StoreFreeShippingOverXEnabled_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.EstimateShippingCartPageEnabled_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.EstimateShippingProductPageEnabled_OverrideForStore, mo => mo.Ignore())
                ...
                cfg.CreateMap<CatalogSettings, CatalogSettingsModel>()
                    ...
                    .ForMember(dest => dest.SecondPictureOnCatalogPages_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.ShowSkuOnCatalogPages_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.DisplayQuantityOnCatalogPages_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.DefaultProductSorting_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.AvailableProductSortingOptions, mo => mo.Ignore())
                    .ForMember(dest => dest.AllowProductFilter_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.ProductAppointmentsMustBeApproved_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.AllowAnonymousUsersToReviewProduct_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.AllowAnonymousUsersToAppointmentProduct_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.NotifyStoreOwnerAboutNewVendorReviews_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.NotifyStoreOwnerAboutNewProductAppointments_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.ShowProductReviewsPerStore_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.ShowProductAppointmentsPerStore_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.ShowProductAppointmentsOnAccountPage_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.ProductReviewsPageSizeOnAccountPage_OverrideForStore, mo => mo.Ignore())
                    .ForMember(dest => dest.ProductAppointmentsPageSizeOnAccountPage_OverrideForStore, mo => mo.Ignore())
                ...
                cfg.CreateMap<OrderSettings, OrderSettingsModel>()
                    ...
                    .ForMember(dest => dest.CustomCheckoutEnabled_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.UnpublishAuctionProduct_OverrideForStore, mo => mo.Ignore())
                ...
                cfg.CreateMap<ShoppingCartSettings, ShoppingCartSettingsModel>()
                    ...
                    .ForMember(dest => dest.SlideShoppingCartEnabled_OverrideForStore, mo => mo.Ignore())
                ...
                cfg.CreateMap<MediaSettings, MediaSettingsModel>()
                    ...
                    .ForMember(dest => dest.BannerPictureSize_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.AddToCartThumbPictureSize_OverrideForStore, mo => mo.Ignore())
                    ...
                    .ForMember(dest => dest.NextGenImages_OverrideForStore, mo => mo.Ignore());
                ...
                //Gdpr model
                cfg.CreateMap<GdprSettings, GdprSettingsModel>()
                ...
                cfg.CreateMap<GdprSettingsModel, GdprSettings>();

                cfg.CreateMap<GdprConsent, GdprConsentModel>();
                cfg.CreateMap<GdprConsentModel, GdprConsent>();

                cfg.CreateMap<GdprLog, GdprLogModel>()
