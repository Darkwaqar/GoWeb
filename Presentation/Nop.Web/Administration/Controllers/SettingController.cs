...
namespace Nop.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        [NonAction]
        private void UpdateLocales(GdprConsent gdprConsent, GdprConsentModel model)
        {
            foreach (var localized in model.Locales)
            {
        ...
        public virtual ActionResult Vendor()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.DefaultCommissionPercentage_OverrideForStore = _settingService.SettingExists(vendorSettings, x => x.DefaultCommissionPercentage, storeScope);
                model.DefaultShippingCharge_OverrideForStore = _settingService.SettingExists(vendorSettings, x => x.DefaultShippingCharge, storeScope);
            }
        ...
        public virtual ActionResult Vendor(VendorSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(vendorSettings, x => x.DefaultCommissionPercentage, model.DefaultCommissionPercentage_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(vendorSettings, x => x.DefaultShippingCharge, model.DefaultShippingCharge_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult Shipping()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.IgnoreAdditionalShippingChargeForPickupInStore_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.IgnoreAdditionalShippingChargeForPickupInStore, storeScope);
                ...
                model.StoreFreeShippingOverXEnabled_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.StoreFreeShippingOverXEnabled, storeScope);
                ...
                model.EstimateShippingCartPageEnabled_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.EstimateShippingCartPageEnabled, storeScope);
                model.EstimateShippingProductPageEnabled_OverrideForStore = _settingService.SettingExists(shippingSettings, x => x.EstimateShippingProductPageEnabled, storeScope);
        ...
        public virtual ActionResult Shipping(ShippingSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(shippingSettings, x => x.StoreFreeShippingOverXEnabled, model.StoreFreeShippingOverXEnabled_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult Catalog()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.DisplayQuantityOnCatalogPages_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.DisplayQuantityOnCatalogPages, storeScope);
                model.SecondPictureOnCatalogPages_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.SecondPictureOnCatalogPages, storeScope);
                ...
                model.DefaultProductSorting_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.DefaultProductSorting, storeScope);
                model.AllowProductFilter_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.AllowProductFilter, storeScope);
                ...
                model.ProductAppointmentsMustBeApproved_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ProductAppointmentsMustBeApproved, storeScope);
                ...
                model.AllowAnonymousUsersToAppointmentProduct_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.AllowAnonymousUsersToAppointmentProduct, storeScope);
                ...
                model.NotifyStoreOwnerAboutNewVendorReviews_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.NotifyStoreOwnerAboutNewVendorReviews, storeScope);
                model.NotifyStoreOwnerAboutNewProductAppointments_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.NotifyStoreOwnerAboutNewProductAppointments, storeScope);
                ...
                model.ShowProductAppointmentsPerStore_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ShowProductAppointmentsPerStore, storeScope);
                ...
                model.ShowProductAppointmentsOnAccountPage_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ShowProductAppointmentsTabOnAccountPage, storeScope);
                ...
                model.ProductAppointmentsPageSizeOnAccountPage_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ProductAppointmentsPageSizeOnAccountPage, storeScope);
                ...
                model.ExportImportProductUseLimitedToStores_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.ExportImportProductUseLimitedToStores, storeScope);
            }

            model.AvailableProductSortingOptions = ProductSortingEnum.Position.ToSelectList(false).ToList();
            return View(model);
        }
        [HttpPost]
        public virtual ActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.DisplayQuantityOnCatalogPages, model.DisplayQuantityOnCatalogPages_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.SecondPictureOnCatalogPages, model.SecondPictureOnCatalogPages_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.DefaultProductSorting, model.DefaultProductSorting_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.AllowProductFilter, model.AllowProductFilter_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ProductAppointmentsMustBeApproved, model.ProductAppointmentsMustBeApproved_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.AllowAnonymousUsersToAppointmentProduct, model.AllowAnonymousUsersToAppointmentProduct_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.NotifyStoreOwnerAboutNewVendorReviews, model.NotifyStoreOwnerAboutNewVendorReviews_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.NotifyStoreOwnerAboutNewProductAppointments, model.NotifyStoreOwnerAboutNewProductAppointments_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ShowProductAppointmentsPerStore, model.ShowProductAppointmentsPerStore_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ShowProductAppointmentsTabOnAccountPage, model.ShowProductAppointmentsOnAccountPage_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.ProductAppointmentsPageSizeOnAccountPage, model.ProductAppointmentsPageSizeOnAccountPage_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult Order()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.CustomCheckoutEnabled_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.CustomCheckoutEnabled, storeScope);
                ...
                model.UserCanCancelUnpaidOrder_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.UserCanCancelUnpaidOrder, storeScope);
                model.AllowCustomerToAddOrderNote_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.AllowCustomerToAddOrderNote, storeScope);
                model.UnpublishAuctionProduct_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.UnpublishAuctionProduct, storeScope);
        ...
        public virtual ActionResult Order(OrderSettingsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.CustomCheckoutEnabled, model.CustomCheckoutEnabled_OverrideForStore, storeScope, false);
                ...
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.UserCanCancelUnpaidOrder, model.UserCanCancelUnpaidOrder_OverrideForStore, storeScope, false);
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.AllowCustomerToAddOrderNote, model.AllowCustomerToAddOrderNote_OverrideForStore, storeScope, false);
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.UnpublishAuctionProduct, model.UnpublishAuctionProduct_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult ShoppingCart()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.SlideShoppingCartEnabled_OverrideForStore = _settingService.SettingExists(shoppingCartSettings, x => x.SlideShoppingCartEnabled, storeScope);
        ...
        public virtual ActionResult ShoppingCart(ShoppingCartSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(shoppingCartSettings, x => x.SlideShoppingCartEnabled, model.SlideShoppingCartEnabled_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult Media()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.BannerPictureSize_OverrideForStore = _settingService.SettingExists(mediaSettings, x => x.BannerPictureSize, storeScope);
                ...
                model.AddToCartThumbPictureSize_OverrideForStore = _settingService.SettingExists(mediaSettings, x => x.AddToCartThumbPictureSize, storeScope);
                ...
                model.NextGenImages_OverrideForStore = _settingService.SettingExists(mediaSettings, x => x.NextGenImages, storeScope);
            }
        ...
        public virtual ActionResult Media(MediaSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(mediaSettings, x => x.BannerPictureSize, model.BannerPictureSize_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(mediaSettings, x => x.AddToCartThumbPictureSize, model.AddToCartThumbPictureSize_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(mediaSettings, x => x.NextGenImages, model.NextGenImages_OverrideForStore, storeScope, false);
        ...
        public virtual ActionResult Gdpr()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            if (storeScope > 0)
            {
                model.GdprEnabled_OverrideForStore = _settingService.SettingExists(gdprSettings, x => x.GdprEnabled, storeScope);
                model.LogPrivacyPolicyConsent_OverrideForStore = _settingService.SettingExists(gdprSettings, x => x.LogPrivacyPolicyConsent, storeScope);
                model.LogNewsletterConsent_OverrideForStore = _settingService.SettingExists(gdprSettings, x => x.LogNewsletterConsent, storeScope);
                model.LogUserProfileChanges_OverrideForStore = _settingService.SettingExists(gdprSettings, x => x.LogUserProfileChanges, storeScope);
            }
        ...
        [HttpPost]
        public virtual ActionResult Gdpr(GdprSettingsModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        public virtual ActionResult GdprConsentList()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            //select "return request" tab
            SaveSelectedTabName("tab-returnrequest");
            return RedirectToAction("Order", "Gdpr");
        }

        [HttpPost]
        public virtual ActionResult GdprConsentList(DataSourceRequest command)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedKendoGridJson();
            ...
            var gridModel = new DataSourceResult
            {
                Data = consentList.Select(x => x.ToModel()),
                Total = consentList.Count
            };
            return Json(gridModel);
        }

        public virtual ActionResult CreateGdprConsent()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public virtual ActionResult CreateGdprConsent(GdprConsentModel model, bool continueEditing)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            if (ModelState.IsValid)
            {
                ...
                //locales                
                UpdateLocales(gdprConsent, model);
        ...
        public virtual ActionResult EditGdprConsent(int id)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
        public virtual ActionResult EditGdprConsent(GdprConsentModel model, bool continueEditing)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (continueEditing)
                {
                    ...
                    return RedirectToAction("EditGdprConsent", new { id = gdprConsent.Id });
                }
                return RedirectToAction("Gdpr");
            }
            //if we got this far, something failed, redisplay form
        ...
        [HttpPost]
        public virtual ActionResult DeleteGdprConsent(int id)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
        ...
        public virtual ActionResult PushNotifications()
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            if (storeScope > 0)
            {
                model.AllowGuestNotifications_OverrideForStore = _settingService.SettingExists(settings, x => x.AllowGuestNotifications, storeScope);
                model.AuthDomain_OverrideForStore = _settingService.SettingExists(settings, x => x.AuthDomain, storeScope);
                model.DatabaseUrl_OverrideForStore = _settingService.SettingExists(settings, x => x.DatabaseUrl, storeScope);
                model.ProjectId_OverrideForStore = _settingService.SettingExists(settings, x => x.ProjectId, storeScope);
                model.PublicApiKey_OverrideForStore = _settingService.SettingExists(settings, x => x.PublicApiKey, storeScope);
                model.SenderId_OverrideForStore = _settingService.SettingExists(settings, x => x.SenderId, storeScope);
                model.StorageBucket_OverrideForStore = _settingService.SettingExists(settings, x => x.StorageBucket, storeScope);
                model.PrivateApiKey_OverrideForStore = _settingService.SettingExists(settings, x => x.PrivateApiKey, storeScope);
        ...
        [HttpPost]
        public virtual ActionResult PushNotifications(PushNotificationsSettingsModel model)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
                return AccessDeniedView();
            ...
            //this behavior can increase performance because cached settings will not be cleared 
            //and loaded from database after each update
            _settingService.SaveSettingOverridablePerStore(settings, x => x.AllowGuestNotifications, model.AllowGuestNotifications_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(settings, x => x.AuthDomain, model.AuthDomain_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(settings, x => x.DatabaseUrl, model.DatabaseUrl_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(settings, x => x.ProjectId, model.ProjectId_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(settings, x => x.PublicApiKey, model.PublicApiKey_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(settings, x => x.SenderId, model.SenderId_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(settings, x => x.StorageBucket, model.StorageBucket_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(settings, x => x.PrivateApiKey, model.PrivateApiKey_OverrideForStore, storeScope, false);
            ...
            if (System.IO.File.Exists(jsFilePath))
            {
                ...
                foreach (var line in lines)
                {
                    ...
                    {
                        lines[i] = "apiKey: \"" + model.PublicApiKey + "\",";
                    }
            ...
            return RedirectToAction("PushNotifications");
        }
        #endregion
        ...
        public virtual ActionResult GeneralCommon()
        {
            ...
            model.StoreInformationSettings.PlayStoreLink = storeInformationSettings.PlayStoreLink;
            model.StoreInformationSettings.AppStoreLink = storeInformationSettings.AppStoreLink;

            //contact us
            model.StoreInformationSettings.StoreInDatabaseContactUsForm = commonSettings.StoreInDatabaseContactUsForm;
            model.StoreInformationSettings.StoreInDatabaseVendorAccountForm = commonSettings.StoreInDatabaseVendorAccountForm;
            model.StoreInformationSettings.StoreInDatabaseAppointmentForm = commonSettings.StoreInDatabaseAppointmentForm;
            model.StoreInformationSettings.SubjectFieldOnContactUsForm = commonSettings.SubjectFieldOnContactUsForm;
            model.StoreInformationSettings.SubjectFieldOnAppointmentForm = commonSettings.SubjectFieldOnAppointmentForm;
            ...
            model.StoreInformationSettings.SitemapIncludeBlogPosts = commonSettings.SitemapIncludeBlogPosts;
            model.StoreInformationSettings.SitemapIncludeNews = commonSettings.SitemapIncludeNews;
            model.StoreInformationSettings.SitemapIncludeTopics = commonSettings.SitemapIncludeTopics;
            ...
            if (storeScope > 0)
            {
                ...
                model.StoreInformationSettings.PlayStoreLink_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.PlayStoreLink, storeScope);
                model.StoreInformationSettings.AppStoreLink_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.AppStoreLink, storeScope);
                ...
                model.StoreInformationSettings.StoreInDatabaseVendorAccountForm_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.StoreInDatabaseVendorAccountForm, storeScope);
                model.StoreInformationSettings.StoreInDatabaseAppointmentForm_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.StoreInDatabaseAppointmentForm, storeScope);
                ...
                model.StoreInformationSettings.SubjectFieldOnAppointmentForm_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SubjectFieldOnAppointmentForm, storeScope);
                ...
                model.StoreInformationSettings.SitemapIncludeBlogPosts_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SitemapIncludeBlogPosts, storeScope);
                model.StoreInformationSettings.SitemapIncludeNews_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SitemapIncludeNews, storeScope);
                model.StoreInformationSettings.SitemapIncludeTopics_OverrideForStore = _settingService.SettingExists(commonSettings, x => x.SitemapIncludeTopics, storeScope);
            }
            ...
            model.SeoSettings.MicrodataEnabled = seoSettings.MicrodataEnabled;
            model.SeoSettings.CustomHeadTags = seoSettings.CustomHeadTags;

            //mobile application helper
            model.SeoSettings.AppPackageIdAndroid = seoSettings.AppPackageIdAndroid;
            model.SeoSettings.AppPackageIdIos = seoSettings.AppPackageIdIos;
            model.SeoSettings.AppUrlSchemesIos = seoSettings.AppUrlSchemesIos;
            model.SeoSettings.AppIdIos = seoSettings.AppIdIos;
            model.SeoSettings.FacebookAppId = seoSettings.FacebookAppId;
            model.SeoSettings.MobileAppPictureId = seoSettings.MobileAppPictureId;
            ...
            if (storeScope > 0)
            {
                ...
                model.SeoSettings.MicrodataEnabled_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.MicrodataEnabled, storeScope);
                ...
                //mobile application helper
                model.SeoSettings.AppPackageIdAndroid_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.AppPackageIdAndroid, storeScope);
                model.SeoSettings.AppPackageIdIos_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.AppPackageIdIos, storeScope);
                model.SeoSettings.AppUrlSchemesIos_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.AppUrlSchemesIos, storeScope);
                model.SeoSettings.AppIdIos_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.AppIdIos, storeScope);
                model.SeoSettings.FacebookAppId_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.FacebookAppId, storeScope);
                model.SeoSettings.MobileAppPictureId_OverrideForStore = _settingService.SettingExists(seoSettings, x => x.MobileAppPictureId, storeScope);
            }
            ...
            model.CaptchaSettings.ShowOnCheckGiftCardBalancePage = captchaSettings.ShowOnCheckGiftCardBalancePage;
            ...
            model.CaptchaSettings.ShowOnApplyVendorPage = captchaSettings.ShowOnApplyVendorPage;
            model.CaptchaSettings.ShowOnProductAppointmentPage = captchaSettings.ShowOnProductAppointmentPage;
            model.CaptchaSettings.ReCaptchaVersion = captchaSettings.ReCaptchaVersion;
            ...
            if (storeScope > 0)
            {
                model.CaptchaSettings.Enabled_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.Enabled, storeScope);
                model.CaptchaSettings.ShowOnLoginPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnLoginPage, storeScope);
                model.CaptchaSettings.ShowOnRegistrationPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnRegistrationPage, storeScope);
                model.CaptchaSettings.ShowOnCheckGiftCardBalancePage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnCheckGiftCardBalancePage, storeScope);
                model.CaptchaSettings.ShowOnContactUsPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnContactUsPage, storeScope);
                model.CaptchaSettings.ShowOnEmailWishlistToFriendPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnEmailWishlistToFriendPage, storeScope);
                model.CaptchaSettings.ShowOnEmailProductToFriendPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnEmailProductToFriendPage, storeScope);
                model.CaptchaSettings.ShowOnBlogCommentPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnBlogCommentPage, storeScope);
                model.CaptchaSettings.ShowOnNewsCommentPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnNewsCommentPage, storeScope);
                model.CaptchaSettings.ShowOnProductReviewPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnProductReviewPage, storeScope);
                model.CaptchaSettings.ShowOnApplyVendorPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnApplyVendorPage, storeScope);
                model.CaptchaSettings.ShowOnProductAppointmentPage_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ShowOnProductAppointmentPage, storeScope);
                model.CaptchaSettings.ReCaptchaVersion_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ReCaptchaVersion, storeScope);
                model.CaptchaSettings.ReCaptchaPublicKey_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ReCaptchaPublicKey, storeScope);
                model.CaptchaSettings.ReCaptchaPrivateKey_OverrideForStore = _settingService.SettingExists(captchaSettings, x => x.ReCaptchaPrivateKey, storeScope);
            }
        ...
        public virtual ActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            storeInformationSettings.PlayStoreLink = model.StoreInformationSettings.PlayStoreLink;
            storeInformationSettings.AppStoreLink = model.StoreInformationSettings.AppStoreLink;
            //terms of service
            ...
            commonSettings.StoreInDatabaseVendorAccountForm = model.StoreInformationSettings.StoreInDatabaseVendorAccountForm;
            commonSettings.StoreInDatabaseAppointmentForm = model.StoreInformationSettings.StoreInDatabaseAppointmentForm;
            commonSettings.SubjectFieldOnContactUsForm = model.StoreInformationSettings.SubjectFieldOnContactUsForm;
            commonSettings.SubjectFieldOnAppointmentForm = model.StoreInformationSettings.SubjectFieldOnAppointmentForm;
            ...
            commonSettings.SitemapIncludeBlogPosts = model.StoreInformationSettings.SitemapIncludeBlogPosts;
            commonSettings.SitemapIncludeNews = model.StoreInformationSettings.SitemapIncludeNews;
            commonSettings.SitemapIncludeTopics = model.StoreInformationSettings.SitemapIncludeTopics;
            ...
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.LinkedInLink, model.StoreInformationSettings.LinkedInLink_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.PinterestLink, model.StoreInformationSettings.PinterestLink_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.PlayStoreLink, model.StoreInformationSettings.PlayStoreLink_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.AppStoreLink, model.StoreInformationSettings.AppStoreLink_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.StoreInDatabaseContactUsForm, model.StoreInformationSettings.StoreInDatabaseContactUsForm_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.StoreInDatabaseVendorAccountForm, model.StoreInformationSettings.StoreInDatabaseVendorAccountForm_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.StoreInDatabaseAppointmentForm, model.StoreInformationSettings.StoreInDatabaseAppointmentForm_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SubjectFieldOnAppointmentForm, model.StoreInformationSettings.SubjectFieldOnAppointmentForm_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SitemapIncludeBlogPosts, model.StoreInformationSettings.SitemapIncludeBlogPosts_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SitemapIncludeNews, model.StoreInformationSettings.SitemapIncludeNews_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(commonSettings, x => x.SitemapIncludeTopics, model.StoreInformationSettings.SitemapIncludeTopics_OverrideForStore, storeScope, false);
            ...
            //mobile application helper
            seoSettings.AppPackageIdAndroid = model.SeoSettings.AppPackageIdAndroid;
            seoSettings.AppPackageIdIos = model.SeoSettings.AppPackageIdIos;
            seoSettings.AppUrlSchemesIos = model.SeoSettings.AppUrlSchemesIos;
            seoSettings.AppIdIos = model.SeoSettings.AppIdIos;
            seoSettings.FacebookAppId = model.SeoSettings.FacebookAppId;
            seoSettings.MobileAppPictureId = model.SeoSettings.MobileAppPictureId;
            ...
            //mobile application helper
            _settingService.SaveSettingOverridablePerStore(seoSettings, x => x.AppPackageIdAndroid, model.SeoSettings.AppPackageIdAndroid_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(seoSettings, x => x.AppPackageIdIos, model.SeoSettings.AppPackageIdIos_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(seoSettings, x => x.AppUrlSchemesIos, model.SeoSettings.AppUrlSchemesIos_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(seoSettings, x => x.AppIdIos, model.SeoSettings.AppIdIos_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(seoSettings, x => x.FacebookAppId, model.SeoSettings.FacebookAppId_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(seoSettings, x => x.MobileAppPictureId, model.SeoSettings.MobileAppPictureId_OverrideForStore, storeScope, false);
            ...
            captchaSettings.ShowOnCheckGiftCardBalancePage = model.CaptchaSettings.ShowOnCheckGiftCardBalancePage;
            captchaSettings.ShowOnContactUsPage = model.CaptchaSettings.ShowOnContactUsPage;
            captchaSettings.ShowOnProductAppointmentPage = model.CaptchaSettings.ShowOnProductAppointmentPage;
            ...
            _settingService.SaveSettingOverridablePerStore(captchaSettings, x => x.ShowOnCheckGiftCardBalancePage, model.CaptchaSettings.ShowOnCheckGiftCardBalancePage_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(captchaSettings, x => x.ShowOnProductAppointmentPage, model.CaptchaSettings.ShowOnProductAppointmentPage_OverrideForStore, storeScope, false);
        ...
        //[HttpPost]
        //public virtual ActionResult UploadIconsArchive(FormFile archivefile)
        //{
        //    if (!_permissionService.Authorize(StandardPermissionProvider.ManageSettings))
        //        return AccessDeniedView();
