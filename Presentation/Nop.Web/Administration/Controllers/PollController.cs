...
namespace Nop.Admin.Controllers
{
    public partial class PollController : BaseAdminController
	{
        ...
        [HttpPost]
        public virtual ActionResult PollAnswerAdd(int pictureId, int displayOrder,
            string overrideAltAttribute, string overrideTitleAttribute, string name, 
            int pollId)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManagePolls))
                return AccessDeniedView();
            ...
            _pictureService.SetSeoFilename(pictureId, _pictureService.GetPictureSeName(poll.Name));
