...
namespace Nop.Admin.Controllers
{
    public partial class DiscountController : BaseAdminController
    {
        ...
        {
            return Json(new { CouponCode = _discountService.GenerateDiscountCardCode() }, JsonRequestBehavior.AllowGet);
        }
        ...
        public virtual ActionResult CategoryAddPopupList(DataSourceRequest command, DiscountModel.AddCategoryToDiscountModel model)
        {
            ...
            var categories = _categoryService.SearchVendorCategories(model.SearchCategoryName,
                model.SearchStoreId, model.SearchVendorId, command.Page - 1, command.PageSize, true);
            var gridModel = new DataSourceResult
            {
