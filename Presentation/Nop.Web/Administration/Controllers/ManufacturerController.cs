    ...
    public partial class ManufacturerController : BaseAdminController
    {
        ...
        public virtual ActionResult List(DataSourceRequest command, ManufacturerListModel model)
        {
            ...
            var manufacturers = _manufacturerService.GetAllManufacturers(model.SearchManufacturerName,
                model.SearchStoreId, command.Page - 1, command.PageSize, model.ShowHidden);
        ...
        public virtual ActionResult DeleteSelected(ICollection<int> selectedIds)
        {
            ...
            if (selectedIds != null)
            {
                _manufacturerService.DeleteManufacturers(_manufacturerService.GetManufacturersByIds(selectedIds.ToArray()));
            }
