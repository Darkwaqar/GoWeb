...
namespace Nop.Admin.Controllers
{
    public partial class HomeController : BaseAdminController
    {
        ...
        #region extended
        [ChildActionOnly]
        public virtual ActionResult CommonStatisticsVendor()
        {
            ...
            model.NumberOfLowStockProducts = _productService.GetLowStockProducts(vendor.Id, 0, 1).TotalCount +
                                             _productService.GetLowStockProductCombinations(vendor.Id, 0, 1).TotalCount;
