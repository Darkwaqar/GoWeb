...
namespace Nop.Admin.Controllers
{
    public partial class SpecificationAttributeController : BaseAdminController
    {
        ...
        public SpecificationAttributeController(IProductService productService, 
        ...
        //used by products
        [HttpPost]
        public virtual ActionResult UsedByProducts(DataSourceRequest command, int specificationAttributeOptionId)
        {
            if (!_permissionService.Authorize(StandardPermissionProvider.ManageAttributes))
                return AccessDeniedKendoGridJson();

            var products = _productService.GetProductsByProductSpecificationId(
