...
namespace Nop.Web.Factories
{
    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
            ...
            bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
        {
            ...
            model.Is2faEnabled = customer.GetAttribute<bool>(SystemCustomerAttributeNames.TwoFactorEnabled);
            model.TwoFactorAuthenticationEnabled = _customerSettings.TwoFactorAuthenticationEnabled;
        ...
        public virtual CustomerNavigationModel PrepareCustomerNavigationModel(int selectedTabId = 0)
        {
            ...
            if (!_customerSettings.HideProductAppointmentsTab)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "CustomerProductAppointments",
                    Title = _localizationService.GetResource("Account.CustomerProductAppointments"),
                    Tab = CustomerNavigationEnum.ProductAppointments,
                    ItemClass = "customer-appointments"
                });
            }
            ...
            if (!_customerSettings.HideAuctionsTab)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "CustomerAuctions",
                    Title = _localizationService.GetResource("Account.CustomerAuctions"),
                    Tab = CustomerNavigationEnum.Auctions,
                    ItemClass = "customer-auctions"
                });
            }
            ...
            if (_catalogSettings.ShowProductAppointmentsTabOnAccountPage)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    RouteName = "CustomerProductAppointments",
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                RouteName = "VendorReviewCenterLoader",
                Title = _localizationService.GetResource("Account.CustomerReviews"),
                Tab = CustomerNavigationEnum.CustomerReviews,
                ItemClass = "customer-reviews"
            });
        ...
        public virtual CustomerAddressListModel PrepareCustomerAddressListModel(int? page = 0)
        {
            ...
            var list = new PagedList<Address>(addresses, --page ?? 0, pageSize);
            ...
            model.PagerModel = new PagerModel
            {
                ...
                RouteActionName = "CustomerAddresses",
                UseRouteLinks = true,
                RouteValues = new CustomerAddressRouteValues { page = page ?? 0 }
            };
            return model;
        }
        ...
        public virtual CustomerAuctionsModel PrepareCustomerAuctionsModel(int customerId, int languageId)
        {
            var model = _productModelFactory.PrepareCustomerAuctionModel(customerId, languageId);
            return model;
        }

        /// <summary>
        /// Prepare the Seller login model
        /// </summary>
        /// <returns>Seller Login model</returns>
        public virtual LoginModel PrepareSellerLoginModel()
        {
            var model = new LoginModel();
            model.UsernamesEnabled = _customerSettings.UsernamesEnabled;
            model.DisplayCaptcha = _captchaSettings.Enabled && _captchaSettings.ShowOnLoginPage;
        ...
        /// <summary>
        /// Prepare the Seller register model
        /// </summary>
        /// <param name="model">Seller register model</param>
        /// <returns>Seller register model</returns>
        public SellerRegisterModel PrepareSellerRegisterModel(SellerRegisterModel model)
        {
            if (model == null)
                throw new ArgumentNullException("model");
        ...
        public virtual CheckGiftCardBalanceModel PrepareCheckGiftCardBalanceModel()
        {
            ...
            model.DisplayCaptcha = _captchaSettings.Enabled && _captchaSettings.ShowOnCheckGiftCardBalancePage;
            return model;
        }
