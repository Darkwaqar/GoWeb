...
namespace Nop.Web.Factories
{
    ...
    public partial class OrderModelFactory : IOrderModelFactory
    {
        ...
        public virtual CustomerOrderListModel PrepareCustomerOrderListModel(int? page = 0)
        {
            var pageSize = 3;
        ...
        public virtual OrderDetailsModel PrepareOrderDetailsModel(Order order)
        {
            ...
            foreach (var orderItem in orderItems)
            {
                ...
                orderItemModel.Picture = PrepareOrderItemPictureModel(orderItem,
                ...
                if (orderItem.Product.VendorId > 0)
                {
                    ...
                    orderItemModel.VendorSeName = vendor.GetSeName();
                }
                //rental info
        ...
        public virtual PictureModel PrepareOrderItemPictureModel(OrderItem sci, int pictureSize, bool showDefaultPicture, string productName)
        {
