...
namespace Nop.Web.Factories
{
    public partial interface ICatalogModelFactory
    {
        ...
        /// </summary>
        /// <returns>List of homepage category models</returns>
        List<CategoryModel> PrepareFeaturedCategoryModels(int vendorId, bool alternativePicture = false);

        /// <summary>
        /// Prepare Featured category models
        /// </summary>
        /// <returns>List of homepage category models</returns>
        List<CategoryModel> PrepareCategoryModels(int vendorId, bool alternativePicture = false);

        /// <summary>
        /// Prepare homepage Collection models
        /// </summary>
        /// <returns>List of homepage Collection models</returns>
        List<CollectionModel> PrepareHomepageCollectionModels();
        ...
        /// </summary>
        /// <returns>List of category (simple) models</returns>
        List<CategorySimpleModel> PrepareMarketPlaceCategorySimpleModels(int rootCategoryId,
        ...
        /// </summary>
        /// <returns>Product tags model</returns>
        PopularProductTagsModel PrepareAllProductTagsModel();
        ...
        /// <summary>
        /// Prepare mobile search model
        /// </summary>
        /// <param name="model">Search model</param>
        /// <param name="command">Catalog paging filtering command</param>
        /// <returns>Search model</returns>
        SearchModel PrepareMobileSearchModel(SearchModel model, CatalogPagingFilteringModel command);
        ...
        /// <param name="vendor">Vendor</param>
        /// <returns>Vendor model</returns>
        VendorMobileModel PrepareVendorMobileModel(Vendor vendor, bool alternativePicture = false);
