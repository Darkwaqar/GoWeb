...
namespace Nop.Web.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        /// <summary>
        /// Prepare the Saler login model
        /// </summary>
        /// <returns>Saler Login model</returns>
        LoginModel PrepareSellerLoginModel();
        ...
        CustomerAddressListModel PrepareCustomerAddressListModel(int? page = 0);
        ...
        CustomerAuctionsModel PrepareCustomerAuctionsModel(int customerId, int languageId);

        /// <summary>
        /// Prepare the Saler register model
        /// </summary>
        /// <param name="model">Saler register model</param>
        /// <returns>Saler register model</returns>
        SellerRegisterModel PrepareSellerRegisterModel(SellerRegisterModel model);
