    ...
    public partial class AddressModelFactory : IAddressModelFactory
    {
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (addressSettings.CountryEnabled && loadCountries != null)
            {
                ...
                model.AvailableDialingCodeCountries.Add(new SelectListItem { Text = _localizationService.GetResource("Address.SelectCode"), Value = "0" });
                foreach (var c in loadCountries())
                {
                    ...
                    {
                        model.AvailableDialingCodeCountries.Add(new SelectListItem
                        {
                            Text = "+" + c.DialingCode.ToString(),
                            Value = c.Id.ToString(),
                            Selected = c.Id == model.CountryId
                        });
                    }
