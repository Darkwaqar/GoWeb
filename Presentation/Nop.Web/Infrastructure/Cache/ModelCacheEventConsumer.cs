...
namespace Nop.Web.Infrastructure.Cache
{
    ...
    public partial class ModelCacheEventConsumer: 
        ...
        //vendors banner
        IConsumer<EntityInserted<VendorBanner>>,
        IConsumer<EntityUpdated<VendorBanner>>,
        IConsumer<EntityDeleted<VendorBanner>>,
        //vendors mobileAppSetting
        IConsumer<EntityInserted<MobileAppSetting>>,
        IConsumer<EntityUpdated<MobileAppSetting>>,
        IConsumer<EntityDeleted<MobileAppSetting>>,
        //vendors socialLinks
        IConsumer<EntityInserted<SocialLinks>>,
        IConsumer<EntityUpdated<SocialLinks>>,
        IConsumer<EntityDeleted<SocialLinks>>,
        ...
        IConsumer<EntityInserted<ProductVideo>>,
        IConsumer<EntityUpdated<ProductVideo>>,
        IConsumer<EntityDeleted<ProductVideo>>,
        //Product review
        ...
        //pollAnswer
        IConsumer<EntityInserted<PollAnswer>>,
        IConsumer<EntityUpdated<PollAnswer>>,
        IConsumer<EntityDeleted<PollAnswer>>,
        //blog posts
        ...
        //Banner Picture
        IConsumer<EntityInserted<BannerPicture>>,
        IConsumer<EntityUpdated<BannerPicture>>,
        IConsumer<EntityDeleted<BannerPicture>>,
        ...
        IConsumer<EntityDeleted<Customer>>
    {
        ...
        /// Key for categories on the search page
        /// </summary>
        public const string MOBILESEARCH_CATEGORIES_MODEL_KEY = "Nop.pres.mobilesearch.categories";
        public const string MOBILESEARCH_CATEGORIES_PATTERN_KEY = "Nop.pres.mobilesearch.categories";
        ...
        /// <summary>
        /// Key for list of MarketPlace CategorySimpleModel caching
        /// </summary>
        /// <remarks>
        /// {0} : language id
        /// {1} : comma separated list of customer roles
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_ALL_MARKETPLACE_MODEL_KEY = "Nop.pres.category.all.marketplace-{0}-{1}-{2}";
        ...
        /// {3} : current store ID
        /// {4} : language ID
        /// {5} : is connection SSL secured (included in a category picture URL)
        /// </remarks>
        ...
        /// <summary>
        /// Key for caching of featured categories by vendorId
        /// </summary>
        /// <remarks>
        /// {0} : vendor ID
        ...
        /// {4} : current store ID
        /// {5} : language ID
        /// {6} : is connection SSL secured (included in a category picture URL)
        /// </remarks>
        public const string CATEGORY_FEATURED_KEY = "Nop.pres.category.featured-{0}-{1}-{2}-{3}-{4}-{5}-{6}";
        public const string CATEGORY_FEATURED_PATTERN_KEY = "Nop.pres.category.featured";


        /// <summary>
        /// Key for caching of categories by vendorId
        /// </summary>
        /// <remarks>
        /// {0} : vendor ID
        /// {1} : alternative picture
        ...
        /// {6} : is connection SSL secured (included in a category picture URL)
        /// </remarks>
        public const string VENDOR_CATEGORY_KEY = "Nop.pres.vendor.category-{0}-{1}-{2}-{3}-{4}-{5}-{6}";
        public const string VENDOR_CATEGORY_PATTERN_KEY = "Nop.pres.vendor.category";
        public const string VENDOR_CATEGORY_PATTERN_KEY_BY_ID = "Nop.pres.vendor.category-{0}-";
        ...
        /// </remarks>
        public const string COLLECTION_HOMEPAGE_KEY = "Nop.pres.collection.homepage-{0}-{1}-{2}-{3}-{4}";
        ...
        /// <summary>
        /// Key for showonhomepage product identifiers displayed on the home page
        /// </summary>
        /// <remarks>
        /// {0} : current customer ID
        /// {1} : current store ID
        /// </remarks>
        public const string HOMEPAGE_PRODUCT_IDS_KEY = "Nop.pres.product.homepage-{0}-{1}";
        public const string HOMEPAGE_PRODUCT_IDS_PATTERN_KEY = "Nop.pres.product.homepage-{0}-";

        /// <summary>
        /// Key for online customer displayed on the chat vendor list
        /// </summary>
        /// <remarks>
        /// {0} : current customer ID
        /// {1} : current store ID
        /// </remarks>
        public const string ONLINE_VENDOR_KEY = "Nop.pres.vendor.chat-{0}-{1}";

        /// <summary>
        /// Key for online customer displayed on the chat inbox
        /// </summary>
        /// <remarks>
        /// {0} : current customer ID
        /// {1} : current store ID
        ...
        /// {0} : current store ID
        /// </remarks>
        public const string CHAT_ALL_VENDOR_CUSTOMER_KEY = "Nop.pres.vendor.customer.all-{0}";
        public const string CHAT_ALL_VENDOR_CUSTOMER_PATTERN_KEY = "Nop.pres.vendor.customer";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_OVERVIEW_PICTURES_MODEL_KEY = "Nop.pres.product.overviewpictures-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_OVERVIEW_PICTURES_PATTERN_KEY = "Nop.pres.product.overviewpictures";
        public const string PRODUCT_OVERVIEW_PICTURES_PATTERN_KEY_BY_ID = "Nop.pres.product.overviewpictures-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string PRODUCT_DETAILS_PICTURES_MODEL_KEY = "Nop.pres.product.detailspictures-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string PRODUCT_DETAILS_PICTURES_PATTERN_KEY = "Nop.pres.product.detailspictures";
        public const string PRODUCT_DETAILS_PICTURES_PATTERN_KEY_BY_ID = "Nop.pres.product.detailspictures-{0}-";
        ...
        /// {4} : current store ID
        /// </remarks>
        public const string PRODUCT_DETAILS_VIDEOS_MODEL_KEY = "Nop.pres.product.detailsvideos-{0}-{1}-{2}-{3}-{4}";
        public const string PRODUCT_DETAILS_VIDEOS_PATTERN_KEY = "Nop.pres.product.detailsvideos";
        public const string PRODUCT_DETAILS_VIDEOS_PATTERN_KEY_BY_ID = "Nop.pres.product.detailsvideos-{0}-";
        ...
        /// <summary>
        /// Key for product vendor caching
        /// </summary>
        /// <remarks>
        /// {0} : product id
        /// {1} :  current store ID
        /// </remarks>
        public const string PRODUCT_VENDOR_MODEL_KEY = "Nop.pres.product.vendor-{0}-{1}";
        public const string PRODUCT_VENDOR_PATTERN_KEY = "Nop.pres.product.vendor";
        public const string PRODUCT_VENDOR_PATTERN_KEY_BY_ID = "Nop.pres.product.vendor-{0}-";
        ...
        /// <summary>
        /// Key for category alternative picture caching
        /// </summary>
        /// <remarks>
        /// {0} : category id
        /// {1} : picture size
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string CATEGORY_ALTERNATIVE_PICTURE_MODEL_KEY = "Nop.pres.category.alternative.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string CATEGORY_ALTERNATIVE_PICTURE_PATTERN_KEY = "Nop.pres.category.alternative.picture";
        public const string CATEGORY_ALTERNATIVE_PICTURE_PATTERN_KEY_BY_ID = "Nop.pres.category.alternative.picture-{0}-";
        ...
        public const string COLLECTION_PICTURE_PATTERN_KEY_BY_ID = "Nop.pres.collection.picture-{0}-";

        /// <summary>
        /// Key for collection logo caching
        /// </summary>
        /// <remarks>
        /// {0} : category id
        /// {1} : picture size
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string COLLECTION_LOGO_MODEL_KEY = "Nop.pres.collection.logo-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string COLLECTION_LOGO_PATTERN_KEY = "Nop.pres.collection.logo";
        public const string COLLECTION_LOGO_PATTERN_KEY_BY_ID = "Nop.pres.collection.logo-{0}-";


        /// <summary>
        /// Key for Collection product caching
        /// </summary>
        /// <remarks>
        /// {0} : category id
        /// {1} : picture size
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string COLLECTION_PRODUCT_MODEL_KEY = "Nop.pres.collection.product-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string COLLECTION_PRODUCT_PATTERN_KEY = "Nop.pres.collection.product";
        public const string COLLECTION_PRODUCT_PATTERN_KEY_BY_ID = "Nop.pres.collection.product-{0}-";
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string VENDOR_SHOPBANNER_MODEL_KEY = "Nop.pres.vendor.shopbanner-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string VENDOR_SHOPBANNER_PATTERN_KEY = "Nop.pres.vendor.shopbanner";
        public const string VENDOR_SHOPBANNER_PATTERN_KEY_BY_ID = "Nop.pres.vendor.shopbanner-{0}-";



        /// <summary>
        /// Key for vendor caching
        /// </summary>
        /// <remarks>
        /// {0} : vendor id
        /// </remarks>
        public const string VENDOR_MOBILE_MODEL_KEY = "Nop.pres.vendor.mobile-{0}";
        public const string VENDOR_MOBILE_PATTERN_KEY = "Nop.pres.vendor.mobile";
        public const string VENDOR_MOBILE_PATTERN_KEY_BY_ID = "Nop.pres.vendor.mobile-{0}-";


        /// <summary>
        /// Key for all vendor caching
        /// </summary>
        /// <remarks>
        /// {0} : vendor is brand 
        /// {0} : vendor is designer 
        /// {0} : vendor is sheearn 
        /// </remarks>
        public const string ALL_VENDOR_MODEL_KEY = "Nop.pres.all.vendor-{0}-{1}-{2}";
        public const string ALL_VENDOR_MODEL_PATTERN_KEY = "Nop.pres.all.vendor";
        ...
        /// {4} : current store ID
        /// </remarks>
        public const string BANNER_PICTURES_MODEL_KEY = "Nop.pres.banner.pictures-{0}-{1}-{2}-{3}-{4}";
        public const string BANNER_PICTURES_PATTERN_KEY = "Nop.pres.banner.pictures";
        public const string BANNER_PICTURES_PATTERN_KEY_BY_ID = "Nop.pres.banner.pictures-{0}-";


        /// <summary>
        /// Key for market category caching
        /// </summary>
        /// <remarks>
        /// {0} : category id
        /// </remarks>
        public const string MARKET_CATEGORY_MODEL_KEY = "Nop.pres.market.category-{0}";
        public const string MARKET_CATEGORY_PATTERN_KEY = "Nop.pres.market.category";
        ...
        /// {1} : current store ID
        /// {2} : current vendor ID
        /// {3} : ShowHidden banners
        /// </remarks>
        public const string ALL_BANNER_MODEL_KEY = "Nop.pres.banner.all-{0}-{1}-{2}-{3}";
        public const string ALL_BANNER_PATTERN_KEY = "Nop.pres.banner.all";
        public const string ALL_BANNER_PATTERN_KEY_BY_ID = "Nop.pres.banner.all-{0}-";



        /// <summary>
        /// Key for poll picture caching
        /// </summary>
        /// <remarks>
        /// {0} : poll id
        /// {1} : picture size
        ...
        /// {5} : current store ID
        /// </remarks>
        public const string POLL_ANSWER_PICTURE_MODEL_KEY = "Nop.pres.pollanswer.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string POLL_ANSWER_PICTURE_PATTERN_KEY = "Nop.pres.pollanswer.picture";
        public const string POLL_ANSWER_PICTURE_PATTERN_KEY_BY_ID = "Nop.pres.pollanswer.picture-{0}-";
        ...
        public void HandleEvent(EntityInserted<Language> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(MOBILESEARCH_CATEGORIES_PATTERN_KEY);
        ...
        public void HandleEvent(EntityInserted<Vendor> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(ALL_VENDOR_MODEL_PATTERN_KEY);
            _cacheManager.RemoveByPattern(string.Format(VENDOR_CATEGORY_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
        ...
        public void HandleEvent(EntityUpdated<Vendor> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(string.Format(VENDOR_SHOPBANNER_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
            _cacheManager.RemoveByPattern(string.Format(VENDOR_MOBILE_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
        }
        ...
        //vendor banner
        public void HandleEvent(EntityInserted<VendorBanner> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<VendorBanner> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }
        public void HandleEvent(EntityDeleted<VendorBanner> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }

        //vendor MobileAppSetting
        public void HandleEvent(EntityInserted<MobileAppSetting> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<MobileAppSetting> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }
        public void HandleEvent(EntityDeleted<MobileAppSetting> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }

        //vendor MobileAppSetting
        public void HandleEvent(EntityInserted<SocialLinks> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<SocialLinks> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }
        public void HandleEvent(EntityDeleted<SocialLinks> eventMessage)
        {
            _cacheManager.RemoveByPattern(VENDOR_MOBILE_PATTERN_KEY);
        }
        ...
        public void HandleEvent(EntityInserted<Category> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(CATEGORY_FEATURED_PATTERN_KEY);
        ...
        public void HandleEvent(EntityUpdated<Category> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(string.Format(CATEGORY_ALTERNATIVE_PICTURE_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
            _cacheManager.RemoveByPattern(string.Format(COLLECTION_PICTURE_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
            _cacheManager.RemoveByPattern(string.Format(COLLECTION_LOGO_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
            _cacheManager.RemoveByPattern(string.Format(COLLECTION_PRODUCT_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
        }
        ...
        public void HandleEvent(EntityUpdated<Product> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(string.Format(PRODUCT_VENDOR_PATTERN_KEY_BY_ID, eventMessage.Entity.Id));
        ...
        {
            _cacheManager.RemoveByPattern(string.Format(PRODUCT_OVERVIEW_PICTURES_PATTERN_KEY_BY_ID, eventMessage.Entity.ProductId));
        ...
        //Product videos mappings
        public void HandleEvent(EntityInserted<ProductVideo> eventMessage)
        {
            _cacheManager.RemoveByPattern(string.Format(PRODUCT_DETAILS_VIDEOS_PATTERN_KEY_BY_ID, eventMessage.Entity.ProductId));
        }
        public void HandleEvent(EntityUpdated<ProductVideo> eventMessage)
        {
            _cacheManager.RemoveByPattern(string.Format(PRODUCT_DETAILS_VIDEOS_PATTERN_KEY_BY_ID, eventMessage.Entity.ProductId));
        }
        public void HandleEvent(EntityDeleted<ProductVideo> eventMessage)
        {
            _cacheManager.RemoveByPattern(string.Format(PRODUCT_DETAILS_VIDEOS_PATTERN_KEY_BY_ID, eventMessage.Entity.ProductId));
        }
        ...
        //Polls
        public void HandleEvent(EntityInserted<PollAnswer> eventMessage)
        {
            _cacheManager.RemoveByPattern(POLL_ANSWER_PICTURE_MODEL_KEY);

        }
        public void HandleEvent(EntityUpdated<PollAnswer> eventMessage)
        {
            _cacheManager.RemoveByPattern(POLL_ANSWER_PICTURE_MODEL_KEY);
        }
        public void HandleEvent(EntityDeleted<PollAnswer> eventMessage)
        {
            _cacheManager.RemoveByPattern(POLL_ANSWER_PICTURE_MODEL_KEY);
        }
        ...
        public void HandleEvent(EntityDeleted<ProductReview> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(string.Format(PRODUCT_VENDOR_PATTERN_KEY_BY_ID, eventMessage.Entity.ProductId));
        }

        //banner
        public void HandleEvent(EntityInserted<Banner> eventMessage)
        {
            _cacheManager.RemoveByPattern(ALL_BANNER_PATTERN_KEY);
        }
        ...
        //banner picture
        public void HandleEvent(EntityInserted<BannerPicture> eventMessage)
        {
            _cacheManager.RemoveByPattern(BANNER_PICTURES_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<BannerPicture> eventMessage)
        {
            _cacheManager.RemoveByPattern(BANNER_PICTURES_PATTERN_KEY);
        }
        public void HandleEvent(EntityDeleted<BannerPicture> eventMessage)
        {
            _cacheManager.RemoveByPattern(BANNER_PICTURES_PATTERN_KEY);
        }
        ...
        {
            _cacheManager.RemoveByPattern(CHAT_ALL_VENDOR_CUSTOMER_PATTERN_KEY);
        }
        public void HandleEvent(EntityUpdated<Customer> eventMessage)
        {
            _cacheManager.RemoveByPattern(CHAT_ALL_VENDOR_CUSTOMER_PATTERN_KEY);
            _cacheManager.RemoveByPattern(string.Format(HOMEPAGE_PRODUCT_IDS_PATTERN_KEY, eventMessage.Entity.Id));
        }
