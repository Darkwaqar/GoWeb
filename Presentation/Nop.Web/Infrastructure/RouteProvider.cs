...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //vendorlogin
            routes.MapLocalizedRoute("VendorLogin",
                            "vendorlogin/",
                            new { controller = "Customer", action = "VendorLogin" },
                            new[] { "Nop.Web.Controllers" });
            //register
            ...
            routes.MapLocalizedRoute("EnableTwoFactorAuthorization",
                           "customer/enable-two-factor-authorization",
                           new { controller = "Customer", action = "EnableTwoFactorAuthenticator" },
                           new[] { "Nop.Web.Controllers" });

            //salerlogin
            routes.MapLocalizedRoute("SellerLogin",
                            "seller/login",
                            new { controller = "Customer", action = "SellerLogin" },
                            new[] { "Nop.Web.Controllers" });
            //salerregister
            routes.MapLocalizedRoute("SellerRegister",
                            "seller/register",
                            new { controller = "Customer", action = "SellerRegister" },
                            new[] { "Nop.Web.Controllers" });

            //loginregister
            routes.MapLocalizedRoute("LoginRegister",
                            "loginregister/",
                            new { controller = "Customer", action = "LoginRegister" },
                            new[] { "Nop.Web.Controllers" });
            //logout
            ...
            //Continue shopping
            routes.MapLocalizedRoute("ContinueShopping",
                            "cart/continueshopping/",
                            new { controller = "ShoppingCart", action = "ContinueShopping" },
                            new[] { "Nop.Web.Controllers" });

            //clear cart
            routes.MapLocalizedRoute("ClearCart",
                            "cart/clear/",
                            new { controller = "ShoppingCart", action = "ClearCart" },
                            new[] { "Nop.Web.Controllers" });

            //start checkout
            routes.MapLocalizedRoute("StartCheckout",
                            "cart/checkout/",
                            new { controller = "ShoppingCart", action = "StartCheckout" },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("ApplyDiscountCoupon",
                            "applydiscountcoupon/",
            ...
            routes.MapLocalizedRoute("UpdateCart",
                           "updatecart/",
                            new { controller = "ShoppingCart", action = "UpdateCart" },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("UpdateWishlist",
                          "updatewishlist/",
                           new { controller = "ShoppingCart", action = "UpdateWishlist" },
                           new[] { "Nop.Web.Controllers" });


            //Delete cart (AJAX link)
            routes.MapRoute("DeleteCartItem",
                            "deletecartitem/{id}",
                            new { controller = "ShoppingCart", action = "DeleteCartItem" },
                            new[] { "Nop.Web.Controllers" });

            //Delete cart (AJAX link)
            routes.MapRoute("DeleteWishlistItem",
                            "deletewishlistitem/{id}",
                            new { controller = "ShoppingCart", action = "DeleteWishlistItem" },
                            new[] { "Nop.Web.Controllers" });

            //Delete cart (AJAX link)
            routes.MapRoute("AddWishlistItemToCart",
            ...
            routes.MapLocalizedRoute("CustomerAddresses",
                            ...
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CustomerAddressesPaged",
                           "customer/addresses/page/{page}",
                           new { controller = "Customer", action = "Addresses" },
                           new { page = @"\d+" },
                           new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CustomerOrders",
                            ...
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CustomerOrdersPaged",
            ...
            //interactive form
            routes.MapLocalizedRoute("PopupAction",
                            "popupaction",
                            new { controller = "Common", action = "PopupAction" },
                            new[] { "Nop.Web.Controllers" });


            //book appointment
            routes.MapLocalizedRoute("BookAppointment",
                            "bookappointment",
                            new { controller = "Common", action = "BookAppointment" },
                            new[] { "Nop.Web.Controllers" });
            ...
            //quick view product
            routes.MapLocalizedRoute("QuickView-Product",
            ...
            routes.MapLocalizedRoute("AddBid",
            ...
            routes.MapLocalizedRoute("CustomerProductReviewsPaged",
                            ...
                            new[] { "Nop.Web.Controllers" });
            //appointments
            routes.MapLocalizedRoute("ProductAppointments",
                            "productappointments/{productId}",
                            new { controller = "Appointment", action = "ProductAppointments" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CustomerProductAppointments",
                            "customer/productappointments",
                            new { controller = "Appointment", action = "CustomerProductAppointments" },
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CustomerProductAppointmentsPaged",
                            "customer/productappointments/page/{page}",
                            new { controller = "Appointment", action = "CustomerProductAppointments" },
                            new { page = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CheckoutOnePage",
                            ...
                            new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("CustomCheckout",
                            "fastcheckout/",
                            new { controller = "Checkout", action = "CustomCheckout" },
                            new[] { "Nop.Web.Controllers" });
            ...
            //subscribe vendor
            routes.MapLocalizedRoute("SubscribeVendorNewsletter",
                            "subscribevendornewsletter",
                            new { controller = "Newsletter", action = "SubscribeVendorNewsletter" },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CustomerAuctions",
                           "customer/auctions",
            ...
            routes.MapLocalizedRoute("TopicPopup",
                            "t-popup/{SystemName}/{css}",
                            new { controller = "Topic", action = "TopicDetailsPopup", css = UrlParameter.Optional },
                            new[] { "Nop.Web.Controllers" });
            ...
            routes.MapLocalizedRoute("CancelOrder",
                           ...
                           new[] { "Nop.Web.Controllers" });
            routes.MapLocalizedRoute("AddOrderNote",
            ...
            //vendor details
            routes.MapLocalizedRoute("VendorDetails",
                            "vendor/vendordetail",
                            new { controller = "Vendor", action = "VendorDetails" },
                            new[] { "Nop.Web.Controllers" });

            //vendor review center

            routes.MapRoute("VendorEditReviewPublic",
                           "edit-extended-review/{OrderId}/{ProductId}",
                           new { controller = "Vendor", action = "EditExtendedReview", },
                           new[] { "Nop.Web.Controllers" });

            routes.MapRoute("VendorReviewCenterLoader",
                           "customer/review-center",
                           new { controller = "Vendor", action = "UserReviews", },
                           new[] { "Nop.Web.Controllers" });

            routes.MapRoute("VendorReviewCenter",
                           "account/review-center/{Type}",
                           new { controller = "Vendor", action = "UserReviewsData", Type = "product", },
                           new[] { "Nop.Web.Controllers" });

            //customer GDPR
            routes.MapRoute("GdprTools",
                            "customer/gdpr",
                            new { controller = "Customer", action = "GdprTools" },
                            new[] { "Nop.Web.Controllers" });

            //customer check gift card balance 
            routes.MapRoute("CheckGiftCardBalance",
                            "customer/checkgiftcardbalance",
            ...
            routes.MapLocalizedRoute("UploadFileContactAttribute",
            ...
            //loginExternal
            routes.MapLocalizedRoute("loginExternal",
                            "loginExternal",
                            new { controller = "Customer", action = "LoginExternal" },
                            new[] { "Nop.Web.Controllers" });
            //PasswordRecoveryExternal
            routes.MapLocalizedRoute("PasswordRecoveryExternal",
                            "PasswordRecoveryExternal",
                            new { controller = "Customer", action = "PasswordRecoveryExternal" },
                            new[] { "Nop.Web.Controllers" });

            //RegisterExternal
            routes.MapLocalizedRoute("RegisterExternal",
                            "RegisterExternal",
                            new { controller = "Customer", action = "RegisterExternal" },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("VendorContact",
                           "VendorContact",
                           new { controller = "Common", action = "VendorContact" },
                           new[] { "Nop.Web.Controllers" });

            //FaqMobile 
            routes.MapLocalizedRoute("FaqMobile",
                            "FaqMobile",
                            new { controller = "Common", action = "FaqMobile" },
                            new[] { "Nop.Web.Controllers" });

            //LoyaltyMobile
            routes.MapLocalizedRoute("LoyaltyMobile",
                            "LoyaltyMobile",
                            new { controller = "Common", action = "LoyaltyMobile" },
                            new[] { "Nop.Web.Controllers" });

            //ShareMobile
            routes.MapLocalizedRoute("Share",
                            "Share",
                            new { controller = "Common", action = "Share" },
                            new[] { "Nop.Web.Controllers" });
            //HomepageCatalog
            routes.MapLocalizedRoute("HomepageCatalog",
                            "HomepageCatalog",
                            new { controller = "Catalog", action = "HomepageCatalog" },
                            new[] { "Nop.Web.Controllers" });
            //OfferSubscribe
            routes.MapLocalizedRoute("OfferSubscribe",
                            "OfferSubscribe",
                            new { controller = "Common", action = "OfferSubscribe" },
                            new[] { "Nop.Web.Controllers" });

            //wifeapply
            routes.MapLocalizedRoute("WifeApply",
                            "starsofpakistan/apply",
                            new { controller = "Common", action = "WifeApply" },
                            new[] { "Nop.Web.Controllers" });
