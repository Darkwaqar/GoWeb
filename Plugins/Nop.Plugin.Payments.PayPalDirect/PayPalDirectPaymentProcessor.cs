...
using Nop.Plugin.Payments.Awein.Controllers;
...
namespace Nop.Plugin.Payments.Awein
{
    ...
    public class PayPalDirectPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary { { "Namespaces", "Nop.Plugin.Payments.Awein.Controllers" }, { "area", null } };
        }
        ...
        public override void Install()
        {
            ...
            //locales
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFee", "Additional fee");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFee.Hint", "Enter additional fee to charge your customers.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFeePercentage", "Additional fee. Use percentage");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFeePercentage.Hint", "Determines whether to apply a percentage additional fee to the order total. If not enabled, a fixed value is used.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientId", "Client ID");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientId.Hint", "Specify client ID.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientSecret", "Client secret");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientSecret.Hint", "Specify secret key.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.PassPurchasedItems", "Pass purchased items");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.PassPurchasedItems.Hint", "Check to pass information about purchased items to PayPal.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.TransactMode", "Transaction mode");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.TransactMode.Hint", "Choose transaction mode.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.UseSandbox", "Use Sandbox");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.UseSandbox.Hint", "Check to enable Sandbox (testing environment).");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.WebhookId", "Webhook ID");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Fields.WebhookId.Hint", "Specify webhook ID.");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.Instructions", "<p><b>If you're using this gateway ensure that your primary store currency is supported by Paypal.</b><br /><br />To configure plugin follow these steps:<br />1. Log into your Developer PayPal account (click <a href=\"https://www.paypal.com/us/webapps/mpp/referral/paypal-business-account2?partner_id=9JJPJNNPQ7PZ8\" target=\"_blank\">here</a> to create your account).<br />2. Click on My Apps & Credentials from the Dashboard.<br />3. Create new REST API app.<br />4. Copy your Client ID and Secret key below.<br />5. To be able to use recurring payments you need to set the webhook ID. You can get it manually in your PayPal account (enter the URL https://www.yourStore.com/Plugins/PaymentPayPalDirect/Webhook below REST API application credentials), or automatically by pressing \"@T(\"Plugins.Payments.Awein.WebhookCreate\")\" button (not visible when running the site locally).<br /></p>");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.PaymentMethodDescription", "Pay by credit / debit card");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.WebhookCreate", "Get webhook ID");
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.Awein.WebhookError", "Webhook was not created (see details in the log)");
        ...
        public override void Uninstall()
        {
            ...
            //locales
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFee");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFee.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFeePercentage");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.AdditionalFeePercentage.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientId");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientId.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientSecret");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.ClientSecret.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.PassPurchasedItems");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.PassPurchasedItems.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.TransactMode");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.TransactMode.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.UseSandbox");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.UseSandbox.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.WebhookId");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Fields.WebhookId.Hint");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.Instructions");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.PaymentMethodDescription");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.WebhookCreate");
            this.DeletePluginLocaleResource("Plugins.Payments.Awein.WebhookError");
        ...
        public string PaymentMethodDescription
        {
            ...
            get { return _localizationService.GetResource("Plugins.Payments.Awein.PaymentMethodDescription"); }
        }
