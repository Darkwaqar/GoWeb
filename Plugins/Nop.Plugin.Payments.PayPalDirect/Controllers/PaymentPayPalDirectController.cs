...
using Nop.Plugin.Payments.Awein.Models;
using Nop.Plugin.Payments.Awein.Validators;
using Nop.Services;
...
namespace Nop.Plugin.Payments.Awein.Controllers
{
    public class PaymentPayPalDirectController : BasePaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("~/Plugins/Payments.Awein/Views/Configure.cshtml", model);
        }
        ...
        public ActionResult GetWebhookId(ConfigurationModel model)
        {
            ...
            if (string.IsNullOrEmpty(payPalDirectPaymentSettings.WebhookId))
                ErrorNotification(_localizationService.GetResource("Plugins.Payments.Awein.WebhookError"));
        ...
        public ActionResult PaymentInfo()
        {
            ...
            return View("~/Plugins/Payments.Awein/Views/PaymentInfo.cshtml", model);
        }
